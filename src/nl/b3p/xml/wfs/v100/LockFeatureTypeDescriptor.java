...
public class LockFeatureTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public LockFeatureTypeDescriptor() 
     {
        ...
        desc.setValidator(fieldValidator);
        //-- _lockAction
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(nl.b3p.xml.wfs.v100.types.AllSomeType.class, "_lockAction", "lockAction", org.exolab.castor.xml.NodeType.Attribute);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    LockFeatureType target = (LockFeatureType) object;
                    target.setLockAction( (nl.b3p.xml.wfs.v100.types.AllSomeType) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- _lockList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(nl.b3p.xml.wfs.v100.Lock.class, "_lockList", "Lock", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    LockFeatureType target = (LockFeatureType) object;
                    target.addLock( (nl.b3p.xml.wfs.v100.Lock) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        desc.setValidator(fieldValidator);
    } //-- nl.b3p.xml.wfs.v100.LockFeatureTypeDescriptor()
    ...
    {
        return nl.b3p.xml.wfs.v100.LockFeatureType.class;
