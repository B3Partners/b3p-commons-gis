...
public class TransactionType implements java.io.Serializable {
     ...
     *  
     */
    private nl.b3p.xml.wfs.v100.types.AllSomeType _releaseAction;
    ...
    } //-- nl.b3p.xml.wfs.v100.TransactionType()
     ...
     */
    public void addTransactionTypeChoice(nl.b3p.xml.wfs.v100.TransactionTypeChoice vTransactionTypeChoice)
        throws java.lang.IndexOutOfBoundsException
    {
        _transactionTypeChoiceList.add(vTransactionTypeChoice);
    } //-- void addTransactionTypeChoice(nl.b3p.xml.wfs.v100.TransactionTypeChoice) 
     ...
     * @param vTransactionTypeChoice
     */
    public void addTransactionTypeChoice(int index, nl.b3p.xml.wfs.v100.TransactionTypeChoice vTransactionTypeChoice)
        throws java.lang.IndexOutOfBoundsException
    {
        _transactionTypeChoiceList.add(index, vTransactionTypeChoice);
    } //-- void addTransactionTypeChoice(int, nl.b3p.xml.wfs.v100.TransactionTypeChoice) 
     ...
     */
    public nl.b3p.xml.wfs.v100.types.AllSomeType getReleaseAction()
    {
        return this._releaseAction;
    } //-- nl.b3p.xml.wfs.v100.types.AllSomeType getReleaseAction() 
     ...
     */
    public nl.b3p.xml.wfs.v100.TransactionTypeChoice getTransactionTypeChoice(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        return (nl.b3p.xml.wfs.v100.TransactionTypeChoice) _transactionTypeChoiceList.get(index);
    } //-- nl.b3p.xml.wfs.v100.TransactionTypeChoice getTransactionTypeChoice(int) 
     ...
     * @return TransactionTypeChoice
     */
    public nl.b3p.xml.wfs.v100.TransactionTypeChoice[] getTransactionTypeChoice()
    {
        int size = _transactionTypeChoiceList.size();
        nl.b3p.xml.wfs.v100.TransactionTypeChoice[] mArray = new nl.b3p.xml.wfs.v100.TransactionTypeChoice[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (nl.b3p.xml.wfs.v100.TransactionTypeChoice) _transactionTypeChoiceList.get(index);
        }
        return mArray;
    } //-- nl.b3p.xml.wfs.v100.TransactionTypeChoice[] getTransactionTypeChoice() 
     ...
     * @return boolean
     */
    public boolean removeTransactionTypeChoice(nl.b3p.xml.wfs.v100.TransactionTypeChoice vTransactionTypeChoice)
    {
        boolean removed = _transactionTypeChoiceList.remove(vTransactionTypeChoice);
        return removed;
    } //-- boolean removeTransactionTypeChoice(nl.b3p.xml.wfs.v100.TransactionTypeChoice) 
     ...
     */
    public void setReleaseAction(nl.b3p.xml.wfs.v100.types.AllSomeType releaseAction)
    {
        this._releaseAction = releaseAction;
    } //-- void setReleaseAction(nl.b3p.xml.wfs.v100.types.AllSomeType) 
     ...
     * @param vTransactionTypeChoice
     */
    public void setTransactionTypeChoice(int index, nl.b3p.xml.wfs.v100.TransactionTypeChoice vTransactionTypeChoice)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index >= _transactionTypeChoiceList.size())) {
    ...
    } //-- void setTransactionTypeChoice(int, nl.b3p.xml.wfs.v100.TransactionTypeChoice) 
     ...
     */
    public void setTransactionTypeChoice(nl.b3p.xml.wfs.v100.TransactionTypeChoice[] transactionTypeChoiceArray)
    {
        //-- copy array
        _transactionTypeChoiceList.clear();
    ...
    } //-- void setTransactionTypeChoice(nl.b3p.xml.wfs.v100.TransactionTypeChoice) 
     ...
     */
    public static nl.b3p.xml.wfs.v100.TransactionType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v100.TransactionType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v100.TransactionType.class, reader);
    } //-- nl.b3p.xml.wfs.v100.TransactionType unmarshal(java.io.Reader) 
