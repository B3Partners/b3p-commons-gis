...
public class WFS_TransactionResponseType implements java.io.Serializable {
     ...
     *  
     */
    private nl.b3p.xml.wfs.v100.TransactionResult _transactionResult;
    ...
    } //-- nl.b3p.xml.wfs.v100.WFS_TransactionResponseType()
     ...
     * @param vInsertResult
     */
    public void addInsertResult(nl.b3p.xml.wfs.v100.InsertResult vInsertResult)
        throws java.lang.IndexOutOfBoundsException
    {
        _insertResultList.add(vInsertResult);
    } //-- void addInsertResult(nl.b3p.xml.wfs.v100.InsertResult) 
     ...
     * @param vInsertResult
     */
    public void addInsertResult(int index, nl.b3p.xml.wfs.v100.InsertResult vInsertResult)
        throws java.lang.IndexOutOfBoundsException
    {
        _insertResultList.add(index, vInsertResult);
    } //-- void addInsertResult(int, nl.b3p.xml.wfs.v100.InsertResult) 
     ...
     * @return InsertResult
     */
    public nl.b3p.xml.wfs.v100.InsertResult getInsertResult(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        return (nl.b3p.xml.wfs.v100.InsertResult) _insertResultList.get(index);
    } //-- nl.b3p.xml.wfs.v100.InsertResult getInsertResult(int) 
     ...
     * @return InsertResult
     */
    public nl.b3p.xml.wfs.v100.InsertResult[] getInsertResult()
    {
        int size = _insertResultList.size();
        nl.b3p.xml.wfs.v100.InsertResult[] mArray = new nl.b3p.xml.wfs.v100.InsertResult[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (nl.b3p.xml.wfs.v100.InsertResult) _insertResultList.get(index);
        }
        return mArray;
    } //-- nl.b3p.xml.wfs.v100.InsertResult[] getInsertResult() 
     ...
     */
    public nl.b3p.xml.wfs.v100.TransactionResult getTransactionResult()
    {
        return this._transactionResult;
    } //-- nl.b3p.xml.wfs.v100.TransactionResult getTransactionResult() 
     ...
     * @return boolean
     */
    public boolean removeInsertResult(nl.b3p.xml.wfs.v100.InsertResult vInsertResult)
    {
        boolean removed = _insertResultList.remove(vInsertResult);
        return removed;
    } //-- boolean removeInsertResult(nl.b3p.xml.wfs.v100.InsertResult) 
     ...
     * @param vInsertResult
     */
    public void setInsertResult(int index, nl.b3p.xml.wfs.v100.InsertResult vInsertResult)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index >= _insertResultList.size())) {
    ...
    } //-- void setInsertResult(int, nl.b3p.xml.wfs.v100.InsertResult) 
     ...
     */
    public void setInsertResult(nl.b3p.xml.wfs.v100.InsertResult[] insertResultArray)
    {
        //-- copy array
        _insertResultList.clear();
    ...
    } //-- void setInsertResult(nl.b3p.xml.wfs.v100.InsertResult) 
     ...
     * 'transactionResult'.
     */
    public void setTransactionResult(nl.b3p.xml.wfs.v100.TransactionResult transactionResult)
    {
        this._transactionResult = transactionResult;
    } //-- void setTransactionResult(nl.b3p.xml.wfs.v100.TransactionResult) 
     ...
     */
    public static nl.b3p.xml.wfs.v100.WFS_TransactionResponseType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v100.WFS_TransactionResponseType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v100.WFS_TransactionResponseType.class, reader);
    } //-- nl.b3p.xml.wfs.v100.WFS_TransactionResponseType unmarshal(java.io.Reader) 
