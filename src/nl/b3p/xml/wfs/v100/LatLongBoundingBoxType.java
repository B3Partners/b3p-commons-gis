...
public class LatLongBoundingBoxType implements java.io.Serializable {
    ...
    public LatLongBoundingBoxType() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v100.LatLongBoundingBoxType()
    ...
    public static nl.b3p.xml.wfs.v100.LatLongBoundingBoxType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v100.LatLongBoundingBoxType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v100.LatLongBoundingBoxType.class, reader);
