...
public class ServiceType implements java.io.Serializable {
    ...
    public ServiceType() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v100.ServiceType()
     ...
     * @return ServiceType
     */
    public static nl.b3p.xml.wfs.v100.ServiceType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v100.ServiceType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v100.ServiceType.class, reader);
    } //-- nl.b3p.xml.wfs.v100.ServiceType unmarshal(java.io.Reader) 
