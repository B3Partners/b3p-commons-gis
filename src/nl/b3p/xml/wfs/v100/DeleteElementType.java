...
public class DeleteElementType implements java.io.Serializable {
    ...
    public DeleteElementType() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v100.DeleteElementType()
     ...
     */
    public static nl.b3p.xml.wfs.v100.DeleteElementType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v100.DeleteElementType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v100.DeleteElementType.class, reader);
    } //-- nl.b3p.xml.wfs.v100.DeleteElementType unmarshal(java.io.Reader) 
