...
implements java.io.Serializable
{
    ...
    public FeaturesLocked() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v100.transaction.FeaturesLocked()
    ...
    public static nl.b3p.xml.wfs.v100.transaction.FeaturesLockedType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v100.transaction.FeaturesLockedType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v100.transaction.FeaturesLocked.class, reader);
