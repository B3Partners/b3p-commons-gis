...
implements java.io.Serializable, nl.b3p.xml.wfs.Transaction
{
    ...
    public Transaction() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v100.transaction.Transaction()
    ...
    public static nl.b3p.xml.wfs.v100.transaction.TransactionType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v100.transaction.TransactionType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v100.transaction.Transaction.class, reader);
