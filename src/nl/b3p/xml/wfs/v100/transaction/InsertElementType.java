...
public class InsertElementType implements java.io.Serializable {
    ...
    } //-- nl.b3p.xml.wfs.v100.transaction.InsertElementType()
    ...
    public static nl.b3p.xml.wfs.v100.transaction.InsertElementType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v100.transaction.InsertElementType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v100.transaction.InsertElementType.class, reader);
