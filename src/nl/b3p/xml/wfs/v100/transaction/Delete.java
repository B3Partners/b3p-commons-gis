 ...
 */
public class Delete extends DeleteElementType 
implements java.io.Serializable
{
    ...
    public Delete() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v100.transaction.Delete()
    ...
    public static nl.b3p.xml.wfs.v100.transaction.DeleteElementType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v100.transaction.DeleteElementType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v100.transaction.Delete.class, reader);
