...
implements java.io.Serializable
{
    ...
    public WFS_TransactionResponse() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v100.transaction.WFS_TransactionResponse()
    ...
    public static nl.b3p.xml.wfs.v100.transaction.WFS_TransactionResponseType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v100.transaction.WFS_TransactionResponseType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v100.transaction.WFS_TransactionResponse.class, reader);
