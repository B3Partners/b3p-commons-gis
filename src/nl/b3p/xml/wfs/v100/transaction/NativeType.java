...
public class NativeType implements java.io.Serializable {
    ...
    public NativeType() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v100.transaction.NativeType()
    ...
    public static nl.b3p.xml.wfs.v100.transaction.NativeType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v100.transaction.NativeType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v100.transaction.NativeType.class, reader);
