 ...
 */
public class GetFeatureTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public GetFeatureTypeDescriptor() 
     {
        super();
        nsURI = "http://www.opengis.net/wfs";
        xmlName = "GetFeatureType";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                GetFeatureType target = (GetFeatureType) object;
        ...
        //-- _queryList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(nl.b3p.xml.wfs.v100.transaction.Query.class, "_queryList", "Query", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    GetFeatureType target = (GetFeatureType) object;
                    target.addQuery( (nl.b3p.xml.wfs.v100.transaction.Query) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new nl.b3p.xml.wfs.v100.transaction.Query();
            }
        };
        desc.setHandler(handler);
        ...
        desc.setValidator(fieldValidator);
    } //-- nl.b3p.xml.wfs.v100.transaction.GetFeatureTypeDescriptor()
    ...
    {
        return nl.b3p.xml.wfs.v100.transaction.GetFeatureType.class;
