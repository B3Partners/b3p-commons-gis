...
implements java.io.Serializable
{
    ...
    public FeatureCollection() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v100.transaction.FeatureCollection()
    ...
    public static nl.b3p.xml.wfs.v100.transaction.FeatureCollectionType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v100.transaction.FeatureCollectionType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v100.transaction.FeatureCollection.class, reader);
