...
public class WFS_LockFeatureResponseType implements java.io.Serializable {
     ...
     *  
     */
    private nl.b3p.xml.wfs.v100.transaction.FeaturesLocked _featuresLocked;
     ...
     *  
     */
    private nl.b3p.xml.wfs.v100.transaction.FeaturesNotLocked _featuresNotLocked;
    ...
    public WFS_LockFeatureResponseType() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v100.transaction.WFS_LockFeatureResponseType()
     ...
     */
    public nl.b3p.xml.wfs.v100.transaction.FeaturesLocked getFeaturesLocked()
    {
        return this._featuresLocked;
    } //-- nl.b3p.xml.wfs.v100.transaction.FeaturesLocked getFeaturesLocked() 
     ...
     */
    public nl.b3p.xml.wfs.v100.transaction.FeaturesNotLocked getFeaturesNotLocked()
    {
        return this._featuresNotLocked;
    } //-- nl.b3p.xml.wfs.v100.transaction.FeaturesNotLocked getFeaturesNotLocked() 
     ...
     */
    public void setFeaturesLocked(nl.b3p.xml.wfs.v100.transaction.FeaturesLocked featuresLocked)
    {
        this._featuresLocked = featuresLocked;
    } //-- void setFeaturesLocked(nl.b3p.xml.wfs.v100.transaction.FeaturesLocked) 
     ...
     * 'featuresNotLocked'.
     */
    public void setFeaturesNotLocked(nl.b3p.xml.wfs.v100.transaction.FeaturesNotLocked featuresNotLocked)
    {
        this._featuresNotLocked = featuresNotLocked;
    } //-- void setFeaturesNotLocked(nl.b3p.xml.wfs.v100.transaction.FeaturesNotLocked) 
     ...
     */
    public static nl.b3p.xml.wfs.v100.transaction.WFS_LockFeatureResponseType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v100.transaction.WFS_LockFeatureResponseType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v100.transaction.WFS_LockFeatureResponseType.class, reader);
    } //-- nl.b3p.xml.wfs.v100.transaction.WFS_LockFeatureResponseType unmarshal(java.io.Reader) 
