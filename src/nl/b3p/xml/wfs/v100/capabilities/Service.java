...
implements java.io.Serializable
{
    ...
    public Service() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v100.capabilities.Service()
    ...
    public static nl.b3p.xml.wfs.v100.capabilities.ServiceType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v100.capabilities.ServiceType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v100.capabilities.Service.class, reader);
