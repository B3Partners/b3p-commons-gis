 ...
 */
public class GetFeatureWithLock extends GetFeatureTypeType 
implements java.io.Serializable
{
    ...
    public GetFeatureWithLock() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v100.capabilities.GetFeatureWithLock()
    ...
    public static nl.b3p.xml.wfs.v100.capabilities.GetFeatureTypeType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v100.capabilities.GetFeatureTypeType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v100.capabilities.GetFeatureWithLock.class, reader);
