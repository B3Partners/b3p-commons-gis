 ...
 */
public class LockFeature extends LockFeatureTypeType 
implements java.io.Serializable
{
    ...
    public LockFeature() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v100.capabilities.LockFeature()
    ...
    public static nl.b3p.xml.wfs.v100.capabilities.LockFeatureTypeType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v100.capabilities.LockFeatureTypeType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v100.capabilities.LockFeature.class, reader);
