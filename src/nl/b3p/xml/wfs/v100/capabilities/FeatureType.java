...
implements java.io.Serializable
{
    ...
    public FeatureType() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v100.capabilities.FeatureType()
    ...
    public static nl.b3p.xml.wfs.v100.capabilities.FeatureTypeType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v100.capabilities.FeatureTypeType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v100.capabilities.FeatureType.class, reader);
