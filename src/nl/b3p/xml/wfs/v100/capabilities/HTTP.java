 ...
 */
public class HTTP extends HTTPType 
implements java.io.Serializable
{
    ...
    public HTTP() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v100.capabilities.HTTP()
    ...
    public static nl.b3p.xml.wfs.v100.capabilities.HTTPType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v100.capabilities.HTTPType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v100.capabilities.HTTP.class, reader);
