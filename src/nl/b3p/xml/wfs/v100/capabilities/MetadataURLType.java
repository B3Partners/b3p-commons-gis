...
public class MetadataURLType implements java.io.Serializable {
    ...
    public MetadataURLType() 
     {
        super();
        setContent("");
    } //-- nl.b3p.xml.wfs.v100.capabilities.MetadataURLType()
    ...
    public static nl.b3p.xml.wfs.v100.capabilities.MetadataURLType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v100.capabilities.MetadataURLType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v100.capabilities.MetadataURLType.class, reader);
