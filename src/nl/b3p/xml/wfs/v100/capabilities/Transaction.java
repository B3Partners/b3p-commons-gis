...
implements java.io.Serializable
{
    ...
    public Transaction() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v100.capabilities.Transaction()
    ...
    public static nl.b3p.xml.wfs.v100.capabilities.TransactionType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v100.capabilities.TransactionType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v100.capabilities.Transaction.class, reader);
