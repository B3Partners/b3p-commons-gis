...
public class FeatureTypeTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public FeatureTypeTypeDescriptor() 
     {
        ...
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(nl.b3p.xml.wfs.v100.capabilities.Operations_FeatureTypeType.class, "_operations_FeatureTypeType", "Operations", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    FeatureTypeType target = (FeatureTypeType) object;
                    target.setOperations_FeatureTypeType( (nl.b3p.xml.wfs.v100.capabilities.Operations_FeatureTypeType) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new nl.b3p.xml.wfs.v100.capabilities.Operations_FeatureTypeType();
            }
        };
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://www.opengis.net/wfs");
        ...
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(nl.b3p.xml.wfs.v100.capabilities.LatLongBoundingBox.class, "_latLongBoundingBoxList", "LatLongBoundingBox", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    FeatureTypeType target = (FeatureTypeType) object;
                    target.addLatLongBoundingBox( (nl.b3p.xml.wfs.v100.capabilities.LatLongBoundingBox) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new nl.b3p.xml.wfs.v100.capabilities.LatLongBoundingBox();
            }
        };
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://www.opengis.net/wfs");
        ...
        desc.setValidator(fieldValidator);
        //-- _metadataURLList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(nl.b3p.xml.wfs.v100.capabilities.MetadataURL.class, "_metadataURLList", "MetadataURL", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    FeatureTypeType target = (FeatureTypeType) object;
                    target.addMetadataURL( (nl.b3p.xml.wfs.v100.capabilities.MetadataURL) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new nl.b3p.xml.wfs.v100.capabilities.MetadataURL();
            }
        };
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://www.opengis.net/wfs");
        ...
        desc.setValidator(fieldValidator);
    } //-- nl.b3p.xml.wfs.v100.capabilities.FeatureTypeTypeDescriptor()
    ...
    {
        return nl.b3p.xml.wfs.v100.capabilities.FeatureTypeType.class;
