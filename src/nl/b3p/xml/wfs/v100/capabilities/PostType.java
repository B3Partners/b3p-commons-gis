...
public class PostType implements java.io.Serializable {
    ...
    public PostType() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v100.capabilities.PostType()
    ...
    public static nl.b3p.xml.wfs.v100.capabilities.PostType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v100.capabilities.PostType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v100.capabilities.PostType.class, reader);
