 ...
 */
public class GMLObjectType extends GMLObjectTypeType 
implements java.io.Serializable
{
    ...
    public GMLObjectType() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v110.GMLObjectType()
    ...
    public static nl.b3p.xml.wfs.v110.GMLObjectTypeType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v110.GMLObjectTypeType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v110.GMLObjectType.class, reader);
