 ...
 */
public class InsertResults extends InsertResultsType 
implements java.io.Serializable
{
    ...
    public InsertResults() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v110.InsertResults()
    ...
    public static nl.b3p.xml.wfs.v110.InsertResultsType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v110.InsertResultsType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v110.InsertResults.class, reader);
