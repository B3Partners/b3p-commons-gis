...
public class WFS_Capabilities extends WFS_CapabilitiesType implements java.io.Serializable,nl.b3p.xml.wfs.WFS_Capabilities
{
    ...
    public WFS_Capabilities() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v110.WFS_Capabilities()
    ...
    public static nl.b3p.xml.wfs.v110.WFS_CapabilitiesType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v110.WFS_CapabilitiesType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v110.WFS_Capabilities.class, reader);
