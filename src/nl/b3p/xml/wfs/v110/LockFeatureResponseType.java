 ...
 */
public class LockFeatureResponseType implements java.io.Serializable {
     ...
     *  
     */
    private nl.b3p.xml.wfs.v110.FeaturesLocked _featuresLocked;
     ...
     *  
     */
    private nl.b3p.xml.wfs.v110.FeaturesNotLocked _featuresNotLocked;
    ...
    public LockFeatureResponseType() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v110.LockFeatureResponseType()
     ...
     */
    public nl.b3p.xml.wfs.v110.FeaturesLocked getFeaturesLocked()
    {
        return this._featuresLocked;
    } //-- nl.b3p.xml.wfs.v110.FeaturesLocked getFeaturesLocked() 
     ...
     */
    public nl.b3p.xml.wfs.v110.FeaturesNotLocked getFeaturesNotLocked()
    {
        return this._featuresNotLocked;
    } //-- nl.b3p.xml.wfs.v110.FeaturesNotLocked getFeaturesNotLocked() 

    /**
     * Returns the value of field 'lockId'. The field 'lockId' has
     * the following description: The LockFeatureResponse includes
     * a LockId element
     *  that contains a lock identifier. The lock identifier
     *  can be used by a client, in subsequent operations, to
     *  operate upon the locked feature instances.
     ...
     */
    public void setFeaturesLocked(nl.b3p.xml.wfs.v110.FeaturesLocked featuresLocked)
    {
        this._featuresLocked = featuresLocked;
    } //-- void setFeaturesLocked(nl.b3p.xml.wfs.v110.FeaturesLocked) 
     ...
     * 'featuresNotLocked'.
     */
    public void setFeaturesNotLocked(nl.b3p.xml.wfs.v110.FeaturesNotLocked featuresNotLocked)
    {
        this._featuresNotLocked = featuresNotLocked;
    } //-- void setFeaturesNotLocked(nl.b3p.xml.wfs.v110.FeaturesNotLocked) 

    /**
     * Sets the value of field 'lockId'. The field 'lockId' has the
     * following description: The LockFeatureResponse includes a
     * LockId element
     *  that contains a lock identifier. The lock identifier
     *  can be used by a client, in subsequent operations, to
     *  operate upon the locked feature instances.
     ...
     */
    public static nl.b3p.xml.wfs.v110.LockFeatureResponseType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v110.LockFeatureResponseType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v110.LockFeatureResponseType.class, reader);
    } //-- nl.b3p.xml.wfs.v110.LockFeatureResponseType unmarshal(java.io.Reader) 
