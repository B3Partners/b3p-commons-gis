 ...
 */
public class GetGmlObject extends GetGmlObjectType 
implements java.io.Serializable
{
    ...
    public GetGmlObject() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v110.GetGmlObject()
    ...
    public static nl.b3p.xml.wfs.v110.BaseRequestType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v110.BaseRequestType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v110.GetGmlObject.class, reader);
