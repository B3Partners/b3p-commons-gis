 ...
 */
public class GetCapabilitiesTypeDescriptor extends nl.b3p.xml.ows.v100.GetCapabilitiesTypeDescriptor {
    ...
    public GetCapabilitiesTypeDescriptor() 
     {
        super();
        setExtendsWithoutFlatten(new nl.b3p.xml.ows.v100.GetCapabilitiesTypeDescriptor());
    ...
    } //-- nl.b3p.xml.wfs.v110.GetCapabilitiesTypeDescriptor()
    ...
    {
        return nl.b3p.xml.wfs.v110.GetCapabilitiesType.class;
