...
implements java.io.Serializable,nl.b3p.xml.wfs.Operations_FeatureTypeType
{
    ...
    public Operations_FeatureTypeType() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v110.Operations_FeatureTypeType()
    ...
    public static nl.b3p.xml.wfs.v110.OperationsType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v110.OperationsType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v110.Operations_FeatureTypeType.class, reader);
