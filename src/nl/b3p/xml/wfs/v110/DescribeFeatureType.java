...
implements java.io.Serializable
{
    ...
    public DescribeFeatureType() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v110.DescribeFeatureType()
    ...
    public static nl.b3p.xml.wfs.v110.BaseRequestType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v110.BaseRequestType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v110.DescribeFeatureType.class, reader);
