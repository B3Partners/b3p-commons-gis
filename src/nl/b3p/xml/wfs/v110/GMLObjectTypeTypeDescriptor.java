 ...
 */
public class GMLObjectTypeTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public GMLObjectTypeTypeDescriptor() 
     {
        super();
        nsURI = "http://www.opengis.net/wfs";
        xmlName = "GMLObjectTypeType";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                GMLObjectTypeType target = (GMLObjectTypeType) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _outputFormats_GMLObjectTypeType
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(nl.b3p.xml.wfs.v110.OutputFormats_GMLObjectTypeType.class, "_outputFormats_GMLObjectTypeType", "OutputFormats", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                GMLObjectTypeType target = (GMLObjectTypeType) object;
                return target.getOutputFormats_GMLObjectTypeType();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    GMLObjectTypeType target = (GMLObjectTypeType) object;
                    target.setOutputFormats_GMLObjectTypeType( (nl.b3p.xml.wfs.v110.OutputFormats_GMLObjectTypeType) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new nl.b3p.xml.wfs.v110.OutputFormats_GMLObjectTypeType();
            }
        };
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://www.opengis.net/wfs");
        ...
        //-- validation code for: _outputFormats_GMLObjectTypeType
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    } //-- nl.b3p.xml.wfs.v110.GMLObjectTypeTypeDescriptor()
    ...
    {
        return nl.b3p.xml.wfs.v110.GMLObjectTypeType.class;
