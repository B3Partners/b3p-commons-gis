...
public class SortPropertyTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public SortPropertyTypeDescriptor() 
     {
        ...
        //-- _sortOrder
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(nl.b3p.xml.ogc.v110.types.SortOrderType.class, "_sortOrder", "SortOrder", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    SortPropertyType target = (SortPropertyType) object;
                    target.setSortOrder( (nl.b3p.xml.ogc.v110.types.SortOrderType) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        handler = new org.exolab.castor.xml.handlers.EnumFieldHandler(nl.b3p.xml.ogc.v110.types.SortOrderType.class, handler);
        ...
        desc.setValidator(fieldValidator);
    } //-- nl.b3p.xml.ogc.v110.SortPropertyTypeDescriptor()
    ...
    {
        return nl.b3p.xml.ogc.v110.SortPropertyType.class;
