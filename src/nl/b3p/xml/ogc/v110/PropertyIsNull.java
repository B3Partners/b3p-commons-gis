 ...
 */
public class PropertyIsNull extends PropertyIsNullType 
implements java.io.Serializable
{
    ...
    public PropertyIsNull() 
     {
        super();
    } //-- nl.b3p.xml.ogc.v110.PropertyIsNull()
    ...
    public static nl.b3p.xml.ogc.v110.ComparisonOpsType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ogc.v110.ComparisonOpsType) Unmarshaller.unmarshal(nl.b3p.xml.ogc.v110.PropertyIsNull.class, reader);
