 ...
 */
public class PropertyIsLessThan extends BinaryComparisonOpType 
implements java.io.Serializable
{
    ...
    public PropertyIsLessThan() 
     {
        super();
    } //-- nl.b3p.xml.ogc.v110.PropertyIsLessThan()
    ...
    public static nl.b3p.xml.ogc.v110.ComparisonOpsType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ogc.v110.ComparisonOpsType) Unmarshaller.unmarshal(nl.b3p.xml.ogc.v110.PropertyIsLessThan.class, reader);
