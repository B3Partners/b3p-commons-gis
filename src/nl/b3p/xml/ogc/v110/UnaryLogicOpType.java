 ...
 */
public class UnaryLogicOpType extends nl.b3p.xml.ogc.v110.LogicOpsType 
implements java.io.Serializable
{
    ...
    public UnaryLogicOpType() 
     {
        super();
    } //-- nl.b3p.xml.ogc.v110.UnaryLogicOpType()
    ...
    public static nl.b3p.xml.ogc.v110.LogicOpsType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ogc.v110.LogicOpsType) Unmarshaller.unmarshal(nl.b3p.xml.ogc.v110.UnaryLogicOpType.class, reader);
