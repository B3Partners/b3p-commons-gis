 ...
 */
public class SpatialOps extends SpatialOpsType 
implements java.io.Serializable
{
    ...
    public SpatialOps() 
     {
        super();
    } //-- nl.b3p.xml.ogc.v110.SpatialOps()
    ...
    public static nl.b3p.xml.ogc.v110.SpatialOpsType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ogc.v110.SpatialOpsType) Unmarshaller.unmarshal(nl.b3p.xml.ogc.v110.SpatialOps.class, reader);
