...
public class Id_CapabilitiesTypeItem implements java.io.Serializable {
     ...
     * Field _EID
     */
    private nl.b3p.xml.ogc.v110.EID _EID;

    /**
     * Field _FID
     */
    private nl.b3p.xml.ogc.v110.FID _FID;
    ...
    public Id_CapabilitiesTypeItem() 
     {
        super();
    } //-- nl.b3p.xml.ogc.v110.Id_CapabilitiesTypeItem()
     ...
     */
    public nl.b3p.xml.ogc.v110.EID getEID()
    {
        return this._EID;
    } //-- nl.b3p.xml.ogc.v110.EID getEID() 
     ...
     */
    public nl.b3p.xml.ogc.v110.FID getFID()
    {
        return this._FID;
    } //-- nl.b3p.xml.ogc.v110.FID getFID() 
     ...
     */
    public void setEID(nl.b3p.xml.ogc.v110.EID EID)
    {
        this._EID = EID;
        this._choiceValue = EID;
    } //-- void setEID(nl.b3p.xml.ogc.v110.EID) 
     ...
     */
    public void setFID(nl.b3p.xml.ogc.v110.FID FID)
    {
        this._FID = FID;
        this._choiceValue = FID;
    } //-- void setFID(nl.b3p.xml.ogc.v110.FID) 
