 ...
 */
public class BinarySpatialOpType extends nl.b3p.xml.ogc.v110.SpatialOpsType 
implements java.io.Serializable
{
     ...
     */
    private nl.b3p.xml.ogc.v110.BinarySpatialOpTypeChoice _binarySpatialOpTypeChoice;
    ...
    public BinarySpatialOpType() 
     {
        super();
    } //-- nl.b3p.xml.ogc.v110.BinarySpatialOpType()
     ...
     */
    public nl.b3p.xml.ogc.v110.BinarySpatialOpTypeChoice getBinarySpatialOpTypeChoice()
    {
        return this._binarySpatialOpTypeChoice;
    } //-- nl.b3p.xml.ogc.v110.BinarySpatialOpTypeChoice getBinarySpatialOpTypeChoice() 
     ...
     */
    public void setBinarySpatialOpTypeChoice(nl.b3p.xml.ogc.v110.BinarySpatialOpTypeChoice binarySpatialOpTypeChoice)
    {
        this._binarySpatialOpTypeChoice = binarySpatialOpTypeChoice;
    } //-- void setBinarySpatialOpTypeChoice(nl.b3p.xml.ogc.v110.BinarySpatialOpTypeChoice) 
    ...
    public static nl.b3p.xml.ogc.v110.SpatialOpsType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ogc.v110.SpatialOpsType) Unmarshaller.unmarshal(nl.b3p.xml.ogc.v110.BinarySpatialOpType.class, reader);
