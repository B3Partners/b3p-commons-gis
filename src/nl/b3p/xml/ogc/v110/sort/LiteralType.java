 ...
 */
public class LiteralType extends nl.b3p.xml.ogc.v110.sort.ExpressionType 
implements java.io.Serializable
{
    ...
    public LiteralType() 
     {
        super();
        setContent("");
    } //-- nl.b3p.xml.ogc.v110.sort.LiteralType()
    ...
    public static nl.b3p.xml.ogc.v110.sort.ExpressionType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ogc.v110.sort.ExpressionType) Unmarshaller.unmarshal(nl.b3p.xml.ogc.v110.sort.LiteralType.class, reader);
