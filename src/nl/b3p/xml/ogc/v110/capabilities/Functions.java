...
implements java.io.Serializable
{
    ...
    public Functions() 
     {
        super();
    } //-- nl.b3p.xml.ogc.v110.capabilities.Functions()
    ...
    public static nl.b3p.xml.ogc.v110.capabilities.FunctionsType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ogc.v110.capabilities.FunctionsType) Unmarshaller.unmarshal(nl.b3p.xml.ogc.v110.capabilities.Functions.class, reader);
