 ...
 */
public class SpatialOperator extends SpatialOperatorType 
implements java.io.Serializable
{
    ...
    public SpatialOperator() 
     {
        super();
    } //-- nl.b3p.xml.ogc.v110.capabilities.SpatialOperator()
    ...
    public static nl.b3p.xml.ogc.v110.capabilities.SpatialOperatorType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ogc.v110.capabilities.SpatialOperatorType) Unmarshaller.unmarshal(nl.b3p.xml.ogc.v110.capabilities.SpatialOperator.class, reader);
