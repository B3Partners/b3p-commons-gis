 ...
 */
public class LiteralTypeDescriptor extends nl.b3p.xml.ogc.v110.ExpressionTypeDescriptor {
    ...
    public LiteralTypeDescriptor() 
     {
        ...
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        desc.setValidator(fieldValidator);
    } //-- nl.b3p.xml.ogc.v110.LiteralTypeDescriptor()
    ...
    {
        return nl.b3p.xml.ogc.v110.LiteralType.class;
