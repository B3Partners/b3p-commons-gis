...
public class ServiceExceptionReportDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ServiceExceptionReportDescriptor() 
     {
        ...
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(nl.b3p.xml.ogc.v100.ServiceException.class, "_serviceExceptionList", "ServiceException", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ServiceExceptionReport target = (ServiceExceptionReport) object;
                    target.addServiceException( (nl.b3p.xml.ogc.v100.ServiceException) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new nl.b3p.xml.ogc.v100.ServiceException();
            }
        };
        desc.setHandler(handler);
        ...
        desc.setValidator(fieldValidator);
    } //-- nl.b3p.xml.ogc.v100.ServiceExceptionReportDescriptor()
    ...
    {
        return nl.b3p.xml.ogc.v100.ServiceExceptionReport.class;
