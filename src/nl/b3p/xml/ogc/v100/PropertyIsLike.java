 ...
 */
public class PropertyIsLike extends PropertyIsLikeType 
implements java.io.Serializable
{
    ...
    public PropertyIsLike() 
     {
        super();
    } //-- nl.b3p.xml.ogc.v100.PropertyIsLike()
    ...
    public static nl.b3p.xml.ogc.v100.ComparisonOpsType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ogc.v100.ComparisonOpsType) Unmarshaller.unmarshal(nl.b3p.xml.ogc.v100.PropertyIsLike.class, reader);
