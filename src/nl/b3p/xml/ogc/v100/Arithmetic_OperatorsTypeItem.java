...
public class Arithmetic_OperatorsTypeItem implements java.io.Serializable {
     ...
     */
    private nl.b3p.xml.ogc.v100.Simple_Arithmetic _simple_Arithmetic;

    /**
     * Field _functions
     */
    private nl.b3p.xml.ogc.v100.Functions _functions;
    ...
    public Arithmetic_OperatorsTypeItem() 
     {
        super();
    } //-- nl.b3p.xml.ogc.v100.Arithmetic_OperatorsTypeItem()
     ...
     */
    public nl.b3p.xml.ogc.v100.Functions getFunctions()
    {
        return this._functions;
    } //-- nl.b3p.xml.ogc.v100.Functions getFunctions() 
     ...
     */
    public nl.b3p.xml.ogc.v100.Simple_Arithmetic getSimple_Arithmetic()
    {
        return this._simple_Arithmetic;
    } //-- nl.b3p.xml.ogc.v100.Simple_Arithmetic getSimple_Arithmetic() 
     ...
     */
    public void setFunctions(nl.b3p.xml.ogc.v100.Functions functions)
    {
        this._functions = functions;
        this._choiceValue = functions;
    } //-- void setFunctions(nl.b3p.xml.ogc.v100.Functions) 
     ...
     * 'simple_Arithmetic'.
     */
    public void setSimple_Arithmetic(nl.b3p.xml.ogc.v100.Simple_Arithmetic simple_Arithmetic)
    {
        this._simple_Arithmetic = simple_Arithmetic;
        this._choiceValue = simple_Arithmetic;
    } //-- void setSimple_Arithmetic(nl.b3p.xml.ogc.v100.Simple_Arithmetic) 
