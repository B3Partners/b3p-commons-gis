 ...
 */
public class LiteralType extends nl.b3p.xml.ogc.v100.ExpressionType 
implements java.io.Serializable
{
    ...
    public LiteralType() 
     {
        super();
        setContent("");
    } //-- nl.b3p.xml.ogc.v100.LiteralType()
    ...
    public static nl.b3p.xml.ogc.v100.ExpressionType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ogc.v100.ExpressionType) Unmarshaller.unmarshal(nl.b3p.xml.ogc.v100.LiteralType.class, reader);
