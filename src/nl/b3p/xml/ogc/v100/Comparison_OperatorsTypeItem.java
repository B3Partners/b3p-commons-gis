...
public class Comparison_OperatorsTypeItem implements java.io.Serializable {
     ...
     */
    private nl.b3p.xml.ogc.v100.Simple_Comparisons _simple_Comparisons;

    /**
     * Field _like
     */
    private nl.b3p.xml.ogc.v100.Like _like;

    /**
     * Field _between
     */
    private nl.b3p.xml.ogc.v100.Between _between;

    /**
     * Field _nullCheck
     */
    private nl.b3p.xml.ogc.v100.NullCheck _nullCheck;
    ...
    public Comparison_OperatorsTypeItem() 
     {
        super();
    } //-- nl.b3p.xml.ogc.v100.Comparison_OperatorsTypeItem()
     ...
     */
    public nl.b3p.xml.ogc.v100.Between getBetween()
    {
        return this._between;
    } //-- nl.b3p.xml.ogc.v100.Between getBetween() 
     ...
     */
    public nl.b3p.xml.ogc.v100.Like getLike()
    {
        return this._like;
    } //-- nl.b3p.xml.ogc.v100.Like getLike() 
     ...
     */
    public nl.b3p.xml.ogc.v100.NullCheck getNullCheck()
    {
        return this._nullCheck;
    } //-- nl.b3p.xml.ogc.v100.NullCheck getNullCheck() 
     ...
     */
    public nl.b3p.xml.ogc.v100.Simple_Comparisons getSimple_Comparisons()
    {
        return this._simple_Comparisons;
    } //-- nl.b3p.xml.ogc.v100.Simple_Comparisons getSimple_Comparisons() 
     ...
     */
    public void setBetween(nl.b3p.xml.ogc.v100.Between between)
    {
        this._between = between;
        this._choiceValue = between;
    } //-- void setBetween(nl.b3p.xml.ogc.v100.Between) 
     ...
     */
    public void setLike(nl.b3p.xml.ogc.v100.Like like)
    {
        this._like = like;
        this._choiceValue = like;
    } //-- void setLike(nl.b3p.xml.ogc.v100.Like) 
     ...
     */
    public void setNullCheck(nl.b3p.xml.ogc.v100.NullCheck nullCheck)
    {
        this._nullCheck = nullCheck;
        this._choiceValue = nullCheck;
    } //-- void setNullCheck(nl.b3p.xml.ogc.v100.NullCheck) 
     ...
     * 'simple_Comparisons'.
     */
    public void setSimple_Comparisons(nl.b3p.xml.ogc.v100.Simple_Comparisons simple_Comparisons)
    {
        this._simple_Comparisons = simple_Comparisons;
        this._choiceValue = simple_Comparisons;
    } //-- void setSimple_Comparisons(nl.b3p.xml.ogc.v100.Simple_Comparisons) 
