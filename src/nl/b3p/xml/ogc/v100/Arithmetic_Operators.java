...
implements java.io.Serializable
{
    ...
    public Arithmetic_Operators() 
     {
        super();
    } //-- nl.b3p.xml.ogc.v100.Arithmetic_Operators()
    ...
    public static nl.b3p.xml.ogc.v100.Arithmetic_OperatorsType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ogc.v100.Arithmetic_OperatorsType) Unmarshaller.unmarshal(nl.b3p.xml.ogc.v100.Arithmetic_Operators.class, reader);
