...
public class ServiceExceptionType implements java.io.Serializable {
    ...
    public ServiceExceptionType() 
     {
        super();
        setContent("");
    } //-- nl.b3p.xml.ogc.v100.exception.ServiceExceptionType()
    ...
    public static nl.b3p.xml.ogc.v100.exception.ServiceExceptionType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ogc.v100.exception.ServiceExceptionType) Unmarshaller.unmarshal(nl.b3p.xml.ogc.v100.exception.ServiceExceptionType.class, reader);
