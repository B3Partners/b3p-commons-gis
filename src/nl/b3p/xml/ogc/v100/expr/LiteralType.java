 ...
 */
public class LiteralType extends nl.b3p.xml.ogc.v100.expr.ExpressionType 
implements java.io.Serializable
{
    ...
    public LiteralType() 
     {
        super();
        setContent("");
    } //-- nl.b3p.xml.ogc.v100.expr.LiteralType()
    ...
    public static nl.b3p.xml.ogc.v100.expr.ExpressionType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ogc.v100.expr.ExpressionType) Unmarshaller.unmarshal(nl.b3p.xml.ogc.v100.expr.LiteralType.class, reader);
