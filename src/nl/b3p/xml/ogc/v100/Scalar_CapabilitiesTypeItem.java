...
public class Scalar_CapabilitiesTypeItem implements java.io.Serializable {
     ...
     */
    private nl.b3p.xml.ogc.v100.Logical_Operators _logical_Operators;

    /**
     * Field _comparison_Operators
     */
    private nl.b3p.xml.ogc.v100.Comparison_Operators _comparison_Operators;

    /**
     * Field _arithmetic_Operators
     */
    private nl.b3p.xml.ogc.v100.Arithmetic_Operators _arithmetic_Operators;
    ...
    public Scalar_CapabilitiesTypeItem() 
     {
        super();
    } //-- nl.b3p.xml.ogc.v100.Scalar_CapabilitiesTypeItem()
     ...
     */
    public nl.b3p.xml.ogc.v100.Arithmetic_Operators getArithmetic_Operators()
    {
        return this._arithmetic_Operators;
    } //-- nl.b3p.xml.ogc.v100.Arithmetic_Operators getArithmetic_Operators() 
     ...
     */
    public nl.b3p.xml.ogc.v100.Comparison_Operators getComparison_Operators()
    {
        return this._comparison_Operators;
    } //-- nl.b3p.xml.ogc.v100.Comparison_Operators getComparison_Operators() 
     ...
     */
    public nl.b3p.xml.ogc.v100.Logical_Operators getLogical_Operators()
    {
        return this._logical_Operators;
    } //-- nl.b3p.xml.ogc.v100.Logical_Operators getLogical_Operators() 
     ...
     */
    public void setArithmetic_Operators(nl.b3p.xml.ogc.v100.Arithmetic_Operators arithmetic_Operators)
    {
        this._arithmetic_Operators = arithmetic_Operators;
        this._choiceValue = arithmetic_Operators;
    } //-- void setArithmetic_Operators(nl.b3p.xml.ogc.v100.Arithmetic_Operators) 
     ...
     */
    public void setComparison_Operators(nl.b3p.xml.ogc.v100.Comparison_Operators comparison_Operators)
    {
        this._comparison_Operators = comparison_Operators;
        this._choiceValue = comparison_Operators;
    } //-- void setComparison_Operators(nl.b3p.xml.ogc.v100.Comparison_Operators) 
     ...
     * 'logical_Operators'.
     */
    public void setLogical_Operators(nl.b3p.xml.ogc.v100.Logical_Operators logical_Operators)
    {
        this._logical_Operators = logical_Operators;
        this._choiceValue = logical_Operators;
    } //-- void setLogical_Operators(nl.b3p.xml.ogc.v100.Logical_Operators) 
