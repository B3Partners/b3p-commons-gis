...
public class DCP implements java.io.Serializable {
     ...
     */
    private nl.b3p.xml.ows.v100.capabilities.HTTP _HTTP;
    ...
    public DCP() 
     {
        super();
    } //-- nl.b3p.xml.ows.v100.capabilities.DCP()
     ...
     */
    public nl.b3p.xml.ows.v100.capabilities.HTTP getHTTP()
    {
        return this._HTTP;
    } //-- nl.b3p.xml.ows.v100.capabilities.HTTP getHTTP() 
     ...
     */
    public void setHTTP(nl.b3p.xml.ows.v100.capabilities.HTTP HTTP)
    {
        this._HTTP = HTTP;
        this._choiceValue = HTTP;
    } //-- void setHTTP(nl.b3p.xml.ows.v100.capabilities.HTTP) 
     ...
     * @return DCP
     */
    public static nl.b3p.xml.ows.v100.capabilities.DCP unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.capabilities.DCP) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.capabilities.DCP.class, reader);
    } //-- nl.b3p.xml.ows.v100.capabilities.DCP unmarshal(java.io.Reader) 
