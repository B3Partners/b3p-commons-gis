...
public class ResponsiblePartySubsetType implements java.io.Serializable {
     ...
     */
    private nl.b3p.xml.ows.v100.capabilities.ContactInfo _contactInfo;
     ...
     */
    private nl.b3p.xml.ows.v100.capabilities.Role _role;
    ...
    public ResponsiblePartySubsetType() 
     {
        super();
    } //-- nl.b3p.xml.ows.v100.capabilities.ResponsiblePartySubsetType()
     ...
     */
    public nl.b3p.xml.ows.v100.capabilities.ContactInfo getContactInfo()
    {
        return this._contactInfo;
    } //-- nl.b3p.xml.ows.v100.capabilities.ContactInfo getContactInfo() 
     ...
     */
    public nl.b3p.xml.ows.v100.capabilities.Role getRole()
    {
        return this._role;
    } //-- nl.b3p.xml.ows.v100.capabilities.Role getRole() 
     ...
     */
    public void setContactInfo(nl.b3p.xml.ows.v100.capabilities.ContactInfo contactInfo)
    {
        this._contactInfo = contactInfo;
    } //-- void setContactInfo(nl.b3p.xml.ows.v100.capabilities.ContactInfo) 
     ...
     */
    public void setRole(nl.b3p.xml.ows.v100.capabilities.Role role)
    {
        this._role = role;
    } //-- void setRole(nl.b3p.xml.ows.v100.capabilities.Role) 
     ...
     */
    public static nl.b3p.xml.ows.v100.capabilities.ResponsiblePartySubsetType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.capabilities.ResponsiblePartySubsetType) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.capabilities.ResponsiblePartySubsetType.class, reader);
    } //-- nl.b3p.xml.ows.v100.capabilities.ResponsiblePartySubsetType unmarshal(java.io.Reader) 
