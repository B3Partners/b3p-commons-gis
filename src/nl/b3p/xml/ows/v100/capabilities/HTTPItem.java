...
public class HTTPItem implements java.io.Serializable {
     ...
     */
    private nl.b3p.xml.ows.v100.capabilities.Get _get;

    /**
     * Connect point URL and any constraints for the HTTP "Post"
     * request method for this operation request. 
     */
    private nl.b3p.xml.ows.v100.capabilities.Post _post;
    ...
    public HTTPItem() 
     {
        super();
    } //-- nl.b3p.xml.ows.v100.capabilities.HTTPItem()
     ...
     */
    public nl.b3p.xml.ows.v100.capabilities.Get getGet()
    {
        return this._get;
    } //-- nl.b3p.xml.ows.v100.capabilities.Get getGet() 
     ...
     */
    public nl.b3p.xml.ows.v100.capabilities.Post getPost()
    {
        return this._post;
    } //-- nl.b3p.xml.ows.v100.capabilities.Post getPost() 
     ...
     */
    public void setGet(nl.b3p.xml.ows.v100.capabilities.Get get)
    {
        this._get = get;
        this._choiceValue = get;
    } //-- void setGet(nl.b3p.xml.ows.v100.capabilities.Get) 
     ...
     */
    public void setPost(nl.b3p.xml.ows.v100.capabilities.Post post)
    {
        this._post = post;
        this._choiceValue = post;
    } //-- void setPost(nl.b3p.xml.ows.v100.capabilities.Post) 
