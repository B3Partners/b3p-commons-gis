 ...
 */
public class WGS84BoundingBoxTypeDescriptor extends nl.b3p.xml.ows.v100.capabilities.BoundingBoxTypeDescriptor {
    ...
    public WGS84BoundingBoxTypeDescriptor() 
     {
        super();
        setExtendsWithoutFlatten(new nl.b3p.xml.ows.v100.capabilities.BoundingBoxTypeDescriptor());
        ...
        desc.setValidator(fieldValidator);
    } //-- nl.b3p.xml.ows.v100.capabilities.WGS84BoundingBoxTypeDescriptor()
    ...
    {
        return nl.b3p.xml.ows.v100.capabilities.WGS84BoundingBoxType.class;
