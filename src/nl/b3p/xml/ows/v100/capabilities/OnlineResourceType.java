...
public class OnlineResourceType implements java.io.Serializable {
    ...
    public OnlineResourceType() 
     {
        super();
        setType("simple");
    } //-- nl.b3p.xml.ows.v100.capabilities.OnlineResourceType()
    ...
    public static nl.b3p.xml.ows.v100.capabilities.OnlineResourceType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.capabilities.OnlineResourceType) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.capabilities.OnlineResourceType.class, reader);
