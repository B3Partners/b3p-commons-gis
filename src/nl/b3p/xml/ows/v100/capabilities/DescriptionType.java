...
public class DescriptionType implements java.io.Serializable {
    ...
    } //-- nl.b3p.xml.ows.v100.capabilities.DescriptionType()
     ...
     * @param vKeywords
     */
    public void addKeywords(nl.b3p.xml.ows.v100.capabilities.Keywords vKeywords)
        throws java.lang.IndexOutOfBoundsException
    {
        _keywordsList.add(vKeywords);
    } //-- void addKeywords(nl.b3p.xml.ows.v100.capabilities.Keywords) 
     ...
     * @param vKeywords
     */
    public void addKeywords(int index, nl.b3p.xml.ows.v100.capabilities.Keywords vKeywords)
        throws java.lang.IndexOutOfBoundsException
    {
        _keywordsList.add(index, vKeywords);
    } //-- void addKeywords(int, nl.b3p.xml.ows.v100.capabilities.Keywords) 
     ...
     * @return Keywords
     */
    public nl.b3p.xml.ows.v100.capabilities.Keywords getKeywords(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        return (nl.b3p.xml.ows.v100.capabilities.Keywords) _keywordsList.get(index);
    } //-- nl.b3p.xml.ows.v100.capabilities.Keywords getKeywords(int) 
     ...
     * @return Keywords
     */
    public nl.b3p.xml.ows.v100.capabilities.Keywords[] getKeywords()
    {
        int size = _keywordsList.size();
        nl.b3p.xml.ows.v100.capabilities.Keywords[] mArray = new nl.b3p.xml.ows.v100.capabilities.Keywords[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (nl.b3p.xml.ows.v100.capabilities.Keywords) _keywordsList.get(index);
        }
        return mArray;
    } //-- nl.b3p.xml.ows.v100.capabilities.Keywords[] getKeywords() 
     ...
     * @return boolean
     */
    public boolean removeKeywords(nl.b3p.xml.ows.v100.capabilities.Keywords vKeywords)
    {
        boolean removed = _keywordsList.remove(vKeywords);
        return removed;
    } //-- boolean removeKeywords(nl.b3p.xml.ows.v100.capabilities.Keywords) 
     ...
     * @param vKeywords
     */
    public void setKeywords(int index, nl.b3p.xml.ows.v100.capabilities.Keywords vKeywords)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index >= _keywordsList.size())) {
    ...
    } //-- void setKeywords(int, nl.b3p.xml.ows.v100.capabilities.Keywords) 
     ...
     * @param keywordsArray
     */
    public void setKeywords(nl.b3p.xml.ows.v100.capabilities.Keywords[] keywordsArray)
    {
        //-- copy array
        _keywordsList.clear();
    ...
    } //-- void setKeywords(nl.b3p.xml.ows.v100.capabilities.Keywords) 
    ...
    public static nl.b3p.xml.ows.v100.capabilities.DescriptionType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.capabilities.DescriptionType) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.capabilities.DescriptionType.class, reader);
