...
/**
 * Class AcceptFormatsTypeDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class AcceptFormatsTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public AcceptFormatsTypeDescriptor() 
     {
        super();
        nsURI = "http://www.opengis.net/ows";
        xmlName = "AcceptFormatsType";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                AcceptFormatsType target = (AcceptFormatsType) object;
    ...
    } //-- nl.b3p.xml.ows.v100.capabilities.AcceptFormatsTypeDescriptor()
    ...
    {
        return nl.b3p.xml.ows.v100.capabilities.AcceptFormatsType.class;
