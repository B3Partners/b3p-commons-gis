...
implements java.io.Serializable
{
    ...
    public PointOfContact() 
     {
        super();
    } //-- nl.b3p.xml.ows.v100.capabilities.PointOfContact()
    ...
    public static nl.b3p.xml.ows.v100.capabilities.ResponsiblePartyType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.capabilities.ResponsiblePartyType) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.capabilities.PointOfContact.class, reader);
