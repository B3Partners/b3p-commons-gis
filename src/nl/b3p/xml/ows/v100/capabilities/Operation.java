...
public class Operation implements java.io.Serializable {
    ...
    } //-- nl.b3p.xml.ows.v100.capabilities.Operation()
     ...
     */
    public void addConstraint_Operation(nl.b3p.xml.ows.v100.capabilities.Constraint_Operation vConstraint_Operation)
        throws java.lang.IndexOutOfBoundsException
    {
        _constraint_OperationList.add(vConstraint_Operation);
    } //-- void addConstraint_Operation(nl.b3p.xml.ows.v100.capabilities.Constraint_Operation) 
     ...
     * @param vConstraint_Operation
     */
    public void addConstraint_Operation(int index, nl.b3p.xml.ows.v100.capabilities.Constraint_Operation vConstraint_Operation)
        throws java.lang.IndexOutOfBoundsException
    {
        _constraint_OperationList.add(index, vConstraint_Operation);
    } //-- void addConstraint_Operation(int, nl.b3p.xml.ows.v100.capabilities.Constraint_Operation) 
     ...
     * @param vDCP
     */
    public void addDCP(nl.b3p.xml.ows.v100.capabilities.DCP vDCP)
        throws java.lang.IndexOutOfBoundsException
    {
        _DCPList.add(vDCP);
    } //-- void addDCP(nl.b3p.xml.ows.v100.capabilities.DCP) 
     ...
     * @param vDCP
     */
    public void addDCP(int index, nl.b3p.xml.ows.v100.capabilities.DCP vDCP)
        throws java.lang.IndexOutOfBoundsException
    {
        _DCPList.add(index, vDCP);
    } //-- void addDCP(int, nl.b3p.xml.ows.v100.capabilities.DCP) 
     ...
     */
    public void addParameter_Operation(nl.b3p.xml.ows.v100.capabilities.Parameter_Operation vParameter_Operation)
        throws java.lang.IndexOutOfBoundsException
    {
        _parameter_OperationList.add(vParameter_Operation);
    } //-- void addParameter_Operation(nl.b3p.xml.ows.v100.capabilities.Parameter_Operation) 
     ...
     * @param vParameter_Operation
     */
    public void addParameter_Operation(int index, nl.b3p.xml.ows.v100.capabilities.Parameter_Operation vParameter_Operation)
        throws java.lang.IndexOutOfBoundsException
    {
        _parameter_OperationList.add(index, vParameter_Operation);
    } //-- void addParameter_Operation(int, nl.b3p.xml.ows.v100.capabilities.Parameter_Operation) 
     ...
     */
    public nl.b3p.xml.ows.v100.capabilities.Constraint_Operation getConstraint_Operation(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        return (nl.b3p.xml.ows.v100.capabilities.Constraint_Operation) _constraint_OperationList.get(index);
    } //-- nl.b3p.xml.ows.v100.capabilities.Constraint_Operation getConstraint_Operation(int) 
     ...
     * @return Constraint_Operation
     */
    public nl.b3p.xml.ows.v100.capabilities.Constraint_Operation[] getConstraint_Operation()
    {
        int size = _constraint_OperationList.size();
        nl.b3p.xml.ows.v100.capabilities.Constraint_Operation[] mArray = new nl.b3p.xml.ows.v100.capabilities.Constraint_Operation[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (nl.b3p.xml.ows.v100.capabilities.Constraint_Operation) _constraint_OperationList.get(index);
        }
        return mArray;
    } //-- nl.b3p.xml.ows.v100.capabilities.Constraint_Operation[] getConstraint_Operation() 
     ...
     * @return DCP
     */
    public nl.b3p.xml.ows.v100.capabilities.DCP getDCP(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        ...
        return (nl.b3p.xml.ows.v100.capabilities.DCP) _DCPList.get(index);
    } //-- nl.b3p.xml.ows.v100.capabilities.DCP getDCP(int) 
     ...
     * @return DCP
     */
    public nl.b3p.xml.ows.v100.capabilities.DCP[] getDCP()
    {
        int size = _DCPList.size();
        nl.b3p.xml.ows.v100.capabilities.DCP[] mArray = new nl.b3p.xml.ows.v100.capabilities.DCP[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (nl.b3p.xml.ows.v100.capabilities.DCP) _DCPList.get(index);
        }
        return mArray;
    } //-- nl.b3p.xml.ows.v100.capabilities.DCP[] getDCP() 
     ...
     */
    public nl.b3p.xml.ows.v100.capabilities.Parameter_Operation getParameter_Operation(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        ...
        return (nl.b3p.xml.ows.v100.capabilities.Parameter_Operation) _parameter_OperationList.get(index);
    } //-- nl.b3p.xml.ows.v100.capabilities.Parameter_Operation getParameter_Operation(int) 
     ...
     * @return Parameter_Operation
     */
    public nl.b3p.xml.ows.v100.capabilities.Parameter_Operation[] getParameter_Operation()
    {
        int size = _parameter_OperationList.size();
        nl.b3p.xml.ows.v100.capabilities.Parameter_Operation[] mArray = new nl.b3p.xml.ows.v100.capabilities.Parameter_Operation[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (nl.b3p.xml.ows.v100.capabilities.Parameter_Operation) _parameter_OperationList.get(index);
        }
        return mArray;
    } //-- nl.b3p.xml.ows.v100.capabilities.Parameter_Operation[] getParameter_Operation() 
     ...
     * @return boolean
     */
    public boolean removeConstraint_Operation(nl.b3p.xml.ows.v100.capabilities.Constraint_Operation vConstraint_Operation)
    {
        boolean removed = _constraint_OperationList.remove(vConstraint_Operation);
        return removed;
    } //-- boolean removeConstraint_Operation(nl.b3p.xml.ows.v100.capabilities.Constraint_Operation) 
     ...
     * @return boolean
     */
    public boolean removeDCP(nl.b3p.xml.ows.v100.capabilities.DCP vDCP)
    {
        boolean removed = _DCPList.remove(vDCP);
        return removed;
    } //-- boolean removeDCP(nl.b3p.xml.ows.v100.capabilities.DCP) 
     ...
     * @return boolean
     */
    public boolean removeParameter_Operation(nl.b3p.xml.ows.v100.capabilities.Parameter_Operation vParameter_Operation)
    {
        boolean removed = _parameter_OperationList.remove(vParameter_Operation);
        return removed;
    } //-- boolean removeParameter_Operation(nl.b3p.xml.ows.v100.capabilities.Parameter_Operation) 
     ...
     * @param vConstraint_Operation
     */
    public void setConstraint_Operation(int index, nl.b3p.xml.ows.v100.capabilities.Constraint_Operation vConstraint_Operation)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index >= _constraint_OperationList.size())) {
    ...
    } //-- void setConstraint_Operation(int, nl.b3p.xml.ows.v100.capabilities.Constraint_Operation) 
     ...
     */
    public void setConstraint_Operation(nl.b3p.xml.ows.v100.capabilities.Constraint_Operation[] constraint_OperationArray)
    {
        //-- copy array
        _constraint_OperationList.clear();
    ...
    } //-- void setConstraint_Operation(nl.b3p.xml.ows.v100.capabilities.Constraint_Operation) 
     ...
     * @param vDCP
     */
    public void setDCP(int index, nl.b3p.xml.ows.v100.capabilities.DCP vDCP)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index >= _DCPList.size())) {
    ...
    } //-- void setDCP(int, nl.b3p.xml.ows.v100.capabilities.DCP) 
     ...
     * @param DCPArray
     */
    public void setDCP(nl.b3p.xml.ows.v100.capabilities.DCP[] DCPArray)
    {
        //-- copy array
        _DCPList.clear();
    ...
    } //-- void setDCP(nl.b3p.xml.ows.v100.capabilities.DCP) 
     ...
     * @param vParameter_Operation
     */
    public void setParameter_Operation(int index, nl.b3p.xml.ows.v100.capabilities.Parameter_Operation vParameter_Operation)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index >= _parameter_OperationList.size())) {
    ...
    } //-- void setParameter_Operation(int, nl.b3p.xml.ows.v100.capabilities.Parameter_Operation) 
     ...
     */
    public void setParameter_Operation(nl.b3p.xml.ows.v100.capabilities.Parameter_Operation[] parameter_OperationArray)
    {
        //-- copy array
        _parameter_OperationList.clear();
    ...
    } //-- void setParameter_Operation(nl.b3p.xml.ows.v100.capabilities.Parameter_Operation) 
     ...
     * @return Operation
     */
    public static nl.b3p.xml.ows.v100.capabilities.Operation unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.capabilities.Operation) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.capabilities.Operation.class, reader);
    } //-- nl.b3p.xml.ows.v100.capabilities.Operation unmarshal(java.io.Reader) 
