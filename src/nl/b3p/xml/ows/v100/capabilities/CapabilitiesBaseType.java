...
public class CapabilitiesBaseType implements java.io.Serializable {
     ...
     */
    private nl.b3p.xml.ows.v100.capabilities.ServiceIdentification _serviceIdentification;

    /**
     * Metadata about the organization that provides this specific
     * service instance or server. 
     */
    private nl.b3p.xml.ows.v100.capabilities.ServiceProvider _serviceProvider;
     ...
     */
    private nl.b3p.xml.ows.v100.capabilities.OperationsMetadata _operationsMetadata;
    ...
    public CapabilitiesBaseType() 
     {
        super();
    } //-- nl.b3p.xml.ows.v100.capabilities.CapabilitiesBaseType()
     ...
     */
    public nl.b3p.xml.ows.v100.capabilities.OperationsMetadata getOperationsMetadata()
    {
        return this._operationsMetadata;
    } //-- nl.b3p.xml.ows.v100.capabilities.OperationsMetadata getOperationsMetadata() 
     ...
     */
    public nl.b3p.xml.ows.v100.capabilities.ServiceIdentification getServiceIdentification()
    {
        return this._serviceIdentification;
    } //-- nl.b3p.xml.ows.v100.capabilities.ServiceIdentification getServiceIdentification() 
     ...
     */
    public nl.b3p.xml.ows.v100.capabilities.ServiceProvider getServiceProvider()
    {
        return this._serviceProvider;
    } //-- nl.b3p.xml.ows.v100.capabilities.ServiceProvider getServiceProvider() 
     ...
     * 'operationsMetadata'.
     */
    public void setOperationsMetadata(nl.b3p.xml.ows.v100.capabilities.OperationsMetadata operationsMetadata)
    {
        this._operationsMetadata = operationsMetadata;
    } //-- void setOperationsMetadata(nl.b3p.xml.ows.v100.capabilities.OperationsMetadata) 
     ...
     */
    public void setServiceIdentification(nl.b3p.xml.ows.v100.capabilities.ServiceIdentification serviceIdentification)
    {
        this._serviceIdentification = serviceIdentification;
    } //-- void setServiceIdentification(nl.b3p.xml.ows.v100.capabilities.ServiceIdentification) 
     ...
     */
    public void setServiceProvider(nl.b3p.xml.ows.v100.capabilities.ServiceProvider serviceProvider)
    {
        this._serviceProvider = serviceProvider;
    } //-- void setServiceProvider(nl.b3p.xml.ows.v100.capabilities.ServiceProvider) 
     ...
     */
    public static nl.b3p.xml.ows.v100.capabilities.CapabilitiesBaseType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.capabilities.CapabilitiesBaseType) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.capabilities.CapabilitiesBaseType.class, reader);
    } //-- nl.b3p.xml.ows.v100.capabilities.CapabilitiesBaseType unmarshal(java.io.Reader) 
