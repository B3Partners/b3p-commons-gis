...
implements java.io.Serializable
{
    ...
    public AcceptVersions() 
     {
        super();
    } //-- nl.b3p.xml.ows.v100.capabilities.AcceptVersions()
    ...
    public static nl.b3p.xml.ows.v100.capabilities.AcceptVersionsType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.capabilities.AcceptVersionsType) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.capabilities.AcceptVersions.class, reader);
