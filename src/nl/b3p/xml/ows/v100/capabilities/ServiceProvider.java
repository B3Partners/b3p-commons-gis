...
public class ServiceProvider implements java.io.Serializable {
     ...
     * provider. 
     */
    private nl.b3p.xml.ows.v100.capabilities.ProviderSite _providerSite;
     ...
     * provider. 
     */
    private nl.b3p.xml.ows.v100.capabilities.ServiceContact _serviceContact;
    ...
    public ServiceProvider() 
     {
        super();
    } //-- nl.b3p.xml.ows.v100.capabilities.ServiceProvider()
     ...
     */
    public nl.b3p.xml.ows.v100.capabilities.ProviderSite getProviderSite()
    {
        return this._providerSite;
    } //-- nl.b3p.xml.ows.v100.capabilities.ProviderSite getProviderSite() 
     ...
     */
    public nl.b3p.xml.ows.v100.capabilities.ServiceContact getServiceContact()
    {
        return this._serviceContact;
    } //-- nl.b3p.xml.ows.v100.capabilities.ServiceContact getServiceContact() 
     ...
     */
    public void setProviderSite(nl.b3p.xml.ows.v100.capabilities.ProviderSite providerSite)
    {
        this._providerSite = providerSite;
    } //-- void setProviderSite(nl.b3p.xml.ows.v100.capabilities.ProviderSite) 
     ...
     */
    public void setServiceContact(nl.b3p.xml.ows.v100.capabilities.ServiceContact serviceContact)
    {
        this._serviceContact = serviceContact;
    } //-- void setServiceContact(nl.b3p.xml.ows.v100.capabilities.ServiceContact) 
     ...
     */
    public static nl.b3p.xml.ows.v100.capabilities.ServiceProvider unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.capabilities.ServiceProvider) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.capabilities.ServiceProvider.class, reader);
    } //-- nl.b3p.xml.ows.v100.capabilities.ServiceProvider unmarshal(java.io.Reader) 
