...
public class GetCapabilitiesType implements java.io.Serializable {
     ...
     */
    private nl.b3p.xml.ows.v100.capabilities.AcceptVersions _acceptVersions;

    /**
     * When omitted or not supported by server, server shall return
     * complete service metadata (Capabilities) document. 
     */
    private nl.b3p.xml.ows.v100.capabilities.Sections _sections;

    /**
     * When omitted or not supported by server, server shall return
     * service metadata document using the MIME type "text/xml". 
     */
    private nl.b3p.xml.ows.v100.capabilities.AcceptFormats _acceptFormats;
    ...
    public GetCapabilitiesType() 
     {
        super();
    } //-- nl.b3p.xml.ows.v100.capabilities.GetCapabilitiesType()
     ...
     */
    public nl.b3p.xml.ows.v100.capabilities.AcceptFormats getAcceptFormats()
    {
        return this._acceptFormats;
    } //-- nl.b3p.xml.ows.v100.capabilities.AcceptFormats getAcceptFormats() 
     ...
     */
    public nl.b3p.xml.ows.v100.capabilities.AcceptVersions getAcceptVersions()
    {
        return this._acceptVersions;
    } //-- nl.b3p.xml.ows.v100.capabilities.AcceptVersions getAcceptVersions() 
     ...
     */
    public nl.b3p.xml.ows.v100.capabilities.Sections getSections()
    {
        return this._sections;
    } //-- nl.b3p.xml.ows.v100.capabilities.Sections getSections() 
     ...
     */
    public void setAcceptFormats(nl.b3p.xml.ows.v100.capabilities.AcceptFormats acceptFormats)
    {
        this._acceptFormats = acceptFormats;
    } //-- void setAcceptFormats(nl.b3p.xml.ows.v100.capabilities.AcceptFormats) 
     ...
     */
    public void setAcceptVersions(nl.b3p.xml.ows.v100.capabilities.AcceptVersions acceptVersions)
    {
        this._acceptVersions = acceptVersions;
    } //-- void setAcceptVersions(nl.b3p.xml.ows.v100.capabilities.AcceptVersions) 
     ...
     */
    public void setSections(nl.b3p.xml.ows.v100.capabilities.Sections sections)
    {
        this._sections = sections;
    } //-- void setSections(nl.b3p.xml.ows.v100.capabilities.Sections) 
     ...
     */
    public static nl.b3p.xml.ows.v100.capabilities.GetCapabilitiesType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.capabilities.GetCapabilitiesType) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.capabilities.GetCapabilitiesType.class, reader);
    } //-- nl.b3p.xml.ows.v100.capabilities.GetCapabilitiesType unmarshal(java.io.Reader) 
