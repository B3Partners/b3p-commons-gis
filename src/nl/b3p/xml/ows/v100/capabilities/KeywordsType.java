...
public class KeywordsType implements java.io.Serializable {
     ...
     * Field _type
     */
    private nl.b3p.xml.ows.v100.capabilities.Type _type;
    ...
    } //-- nl.b3p.xml.ows.v100.capabilities.KeywordsType()
     ...
     */
    public nl.b3p.xml.ows.v100.capabilities.Type getType()
    {
        return this._type;
    } //-- nl.b3p.xml.ows.v100.capabilities.Type getType() 
     ...
     */
    public void setType(nl.b3p.xml.ows.v100.capabilities.Type type)
    {
        this._type = type;
    } //-- void setType(nl.b3p.xml.ows.v100.capabilities.Type) 
     ...
     * @return KeywordsType
     */
    public static nl.b3p.xml.ows.v100.capabilities.KeywordsType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.capabilities.KeywordsType) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.capabilities.KeywordsType.class, reader);
    } //-- nl.b3p.xml.ows.v100.capabilities.KeywordsType unmarshal(java.io.Reader) 
