...
public class ExceptionReport implements java.io.Serializable {
    ...
    } //-- nl.b3p.xml.ows.v100.ExceptionReport()
     ...
     * @param vException
     */
    public void addException(nl.b3p.xml.ows.v100.Exception vException)
        throws java.lang.IndexOutOfBoundsException
    {
        _exceptionList.add(vException);
    } //-- void addException(nl.b3p.xml.ows.v100.Exception) 
     ...
     * @param vException
     */
    public void addException(int index, nl.b3p.xml.ows.v100.Exception vException)
        throws java.lang.IndexOutOfBoundsException
    {
        _exceptionList.add(index, vException);
    } //-- void addException(int, nl.b3p.xml.ows.v100.Exception) 
     ...
     * @return Exception
     */
    public nl.b3p.xml.ows.v100.Exception getException(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        return (nl.b3p.xml.ows.v100.Exception) _exceptionList.get(index);
    } //-- nl.b3p.xml.ows.v100.Exception getException(int) 
     ...
     * @return Exception
     */
    public nl.b3p.xml.ows.v100.Exception[] getException()
    {
        int size = _exceptionList.size();
        nl.b3p.xml.ows.v100.Exception[] mArray = new nl.b3p.xml.ows.v100.Exception[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (nl.b3p.xml.ows.v100.Exception) _exceptionList.get(index);
        }
        return mArray;
    } //-- nl.b3p.xml.ows.v100.Exception[] getException() 
     ...
     * @return boolean
     */
    public boolean removeException(nl.b3p.xml.ows.v100.Exception vException)
    {
        boolean removed = _exceptionList.remove(vException);
        return removed;
    } //-- boolean removeException(nl.b3p.xml.ows.v100.Exception) 
     ...
     * @param vException
     */
    public void setException(int index, nl.b3p.xml.ows.v100.Exception vException)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index >= _exceptionList.size())) {
    ...
    } //-- void setException(int, nl.b3p.xml.ows.v100.Exception) 
     ...
     */
    public void setException(nl.b3p.xml.ows.v100.Exception[] exceptionArray)
    {
        //-- copy array
        _exceptionList.clear();
    ...
    } //-- void setException(nl.b3p.xml.ows.v100.Exception) 
     ...
     */
    public static nl.b3p.xml.ows.v100.ExceptionReport unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.ExceptionReport) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.ExceptionReport.class, reader);
    } //-- nl.b3p.xml.ows.v100.ExceptionReport unmarshal(java.io.Reader) 
