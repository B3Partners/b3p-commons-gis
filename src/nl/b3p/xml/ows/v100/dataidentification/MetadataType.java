...
public class MetadataType implements java.io.Serializable {
    ...
    public MetadataType() 
     {
        super();
        setType("simple");
    } //-- nl.b3p.xml.ows.v100.dataidentification.MetadataType()
     ...
     * @return MetadataType
     */
    public static nl.b3p.xml.ows.v100.dataidentification.MetadataType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.dataidentification.MetadataType) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.dataidentification.MetadataType.class, reader);
    } //-- nl.b3p.xml.ows.v100.dataidentification.MetadataType unmarshal(java.io.Reader) 
