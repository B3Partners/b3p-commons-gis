...
public class ContactType implements java.io.Serializable {
     ...
     * may be contacted. 
     */
    private nl.b3p.xml.ows.v100.dataidentification.Phone _phone;

    /**
     * Physical and email address at which the organization or
     * individual may be contacted. 
     */
    private nl.b3p.xml.ows.v100.dataidentification.Address _address;
     ...
     * not be used. 
     */
    private nl.b3p.xml.ows.v100.dataidentification.OnlineResource _onlineResource;
    ...
    public ContactType() 
     {
        super();
    } //-- nl.b3p.xml.ows.v100.dataidentification.ContactType()
     ...
     */
    public nl.b3p.xml.ows.v100.dataidentification.Address getAddress()
    {
        return this._address;
    } //-- nl.b3p.xml.ows.v100.dataidentification.Address getAddress() 
     ...
     */
    public nl.b3p.xml.ows.v100.dataidentification.OnlineResource getOnlineResource()
    {
        return this._onlineResource;
    } //-- nl.b3p.xml.ows.v100.dataidentification.OnlineResource getOnlineResource() 
     ...
     */
    public nl.b3p.xml.ows.v100.dataidentification.Phone getPhone()
    {
        return this._phone;
    } //-- nl.b3p.xml.ows.v100.dataidentification.Phone getPhone() 
     ...
     */
    public void setAddress(nl.b3p.xml.ows.v100.dataidentification.Address address)
    {
        this._address = address;
    } //-- void setAddress(nl.b3p.xml.ows.v100.dataidentification.Address) 
     ...
     */
    public void setOnlineResource(nl.b3p.xml.ows.v100.dataidentification.OnlineResource onlineResource)
    {
        this._onlineResource = onlineResource;
    } //-- void setOnlineResource(nl.b3p.xml.ows.v100.dataidentification.OnlineResource) 
     ...
     */
    public void setPhone(nl.b3p.xml.ows.v100.dataidentification.Phone phone)
    {
        this._phone = phone;
    } //-- void setPhone(nl.b3p.xml.ows.v100.dataidentification.Phone) 
     ...
     * @return ContactType
     */
    public static nl.b3p.xml.ows.v100.dataidentification.ContactType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.dataidentification.ContactType) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.dataidentification.ContactType.class, reader);
    } //-- nl.b3p.xml.ows.v100.dataidentification.ContactType unmarshal(java.io.Reader) 
