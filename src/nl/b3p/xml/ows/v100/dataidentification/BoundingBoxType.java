...
public class BoundingBoxType implements java.io.Serializable {
    ...
    } //-- nl.b3p.xml.ows.v100.dataidentification.BoundingBoxType()
    ...
    public static nl.b3p.xml.ows.v100.dataidentification.BoundingBoxType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.dataidentification.BoundingBoxType) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.dataidentification.BoundingBoxType.class, reader);
