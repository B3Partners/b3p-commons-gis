...
public class CodeType implements java.io.Serializable {
    ...
    public CodeType() 
     {
        super();
        setContent("");
    } //-- nl.b3p.xml.ows.v100.dataidentification.CodeType()
    ...
    public static nl.b3p.xml.ows.v100.dataidentification.CodeType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.dataidentification.CodeType) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.dataidentification.CodeType.class, reader);
