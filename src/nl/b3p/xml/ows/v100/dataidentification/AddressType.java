...
public class AddressType implements java.io.Serializable {
    ...
    } //-- nl.b3p.xml.ows.v100.dataidentification.AddressType()
     ...
     * @return AddressType
     */
    public static nl.b3p.xml.ows.v100.dataidentification.AddressType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.dataidentification.AddressType) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.dataidentification.AddressType.class, reader);
    } //-- nl.b3p.xml.ows.v100.dataidentification.AddressType unmarshal(java.io.Reader) 
