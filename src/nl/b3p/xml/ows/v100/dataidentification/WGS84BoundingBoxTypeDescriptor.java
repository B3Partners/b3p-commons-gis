 ...
 */
public class WGS84BoundingBoxTypeDescriptor extends nl.b3p.xml.ows.v100.dataidentification.BoundingBoxTypeDescriptor {
    ...
    public WGS84BoundingBoxTypeDescriptor() 
     {
        super();
        setExtendsWithoutFlatten(new nl.b3p.xml.ows.v100.dataidentification.BoundingBoxTypeDescriptor());
        ...
        desc.setValidator(fieldValidator);
    } //-- nl.b3p.xml.ows.v100.dataidentification.WGS84BoundingBoxTypeDescriptor()
    ...
    {
        return nl.b3p.xml.ows.v100.dataidentification.WGS84BoundingBoxType.class;
