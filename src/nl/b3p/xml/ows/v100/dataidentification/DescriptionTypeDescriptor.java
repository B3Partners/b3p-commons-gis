...
public class DescriptionTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public DescriptionTypeDescriptor() 
     {
        ...
        desc.setValidator(fieldValidator);
        //-- _keywordsList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(nl.b3p.xml.ows.v100.dataidentification.Keywords.class, "_keywordsList", "Keywords", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    DescriptionType target = (DescriptionType) object;
                    target.addKeywords( (nl.b3p.xml.ows.v100.dataidentification.Keywords) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new nl.b3p.xml.ows.v100.dataidentification.Keywords();
            }
        };
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://www.opengis.net/ows");
        ...
        desc.setValidator(fieldValidator);
    } //-- nl.b3p.xml.ows.v100.dataidentification.DescriptionTypeDescriptor()
    ...
    {
        return nl.b3p.xml.ows.v100.dataidentification.DescriptionType.class;
