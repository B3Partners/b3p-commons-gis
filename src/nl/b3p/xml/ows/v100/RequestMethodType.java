...
implements java.io.Serializable
{
     ...
     */
    public void addConstraint_RequestMethodType(nl.b3p.xml.ows.v100.Constraint_RequestMethodType vConstraint_RequestMethodType)
        throws java.lang.IndexOutOfBoundsException
    {
        _constraint_RequestMethodTypeList.add(vConstraint_RequestMethodType);
    } //-- void addConstraint_RequestMethodType(nl.b3p.xml.ows.v100.Constraint_RequestMethodType) 
     ...
     * @param vConstraint_RequestMethodType
     */
    public void addConstraint_RequestMethodType(int index, nl.b3p.xml.ows.v100.Constraint_RequestMethodType vConstraint_RequestMethodType)
        throws java.lang.IndexOutOfBoundsException
    {
        _constraint_RequestMethodTypeList.add(index, vConstraint_RequestMethodType);
    } //-- void addConstraint_RequestMethodType(int, nl.b3p.xml.ows.v100.Constraint_RequestMethodType) 
     ...
     */
    public nl.b3p.xml.ows.v100.Constraint_RequestMethodType getConstraint_RequestMethodType(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        return (nl.b3p.xml.ows.v100.Constraint_RequestMethodType) _constraint_RequestMethodTypeList.get(index);
    } //-- nl.b3p.xml.ows.v100.Constraint_RequestMethodType getConstraint_RequestMethodType(int) 
     ...
     * @return Constraint_RequestMethodType
     */
    public nl.b3p.xml.ows.v100.Constraint_RequestMethodType[] getConstraint_RequestMethodType()
    {
        int size = _constraint_RequestMethodTypeList.size();
        nl.b3p.xml.ows.v100.Constraint_RequestMethodType[] mArray = new nl.b3p.xml.ows.v100.Constraint_RequestMethodType[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (nl.b3p.xml.ows.v100.Constraint_RequestMethodType) _constraint_RequestMethodTypeList.get(index);
        }
        return mArray;
    } //-- nl.b3p.xml.ows.v100.Constraint_RequestMethodType[] getConstraint_RequestMethodType() 
     ...
     * @return boolean
     */
    public boolean removeConstraint_RequestMethodType(nl.b3p.xml.ows.v100.Constraint_RequestMethodType vConstraint_RequestMethodType)
    {
        boolean removed = _constraint_RequestMethodTypeList.remove(vConstraint_RequestMethodType);
        return removed;
    } //-- boolean removeConstraint_RequestMethodType(nl.b3p.xml.ows.v100.Constraint_RequestMethodType) 
     ...
     * @param vConstraint_RequestMethodType
     */
    public void setConstraint_RequestMethodType(int index, nl.b3p.xml.ows.v100.Constraint_RequestMethodType vConstraint_RequestMethodType)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index >= _constraint_RequestMethodTypeList.size())) {
    ...
    } //-- void setConstraint_RequestMethodType(int, nl.b3p.xml.ows.v100.Constraint_RequestMethodType) 
     ...
     */
    public void setConstraint_RequestMethodType(nl.b3p.xml.ows.v100.Constraint_RequestMethodType[] constraint_RequestMethodTypeArray)
    {
        //-- copy array
        _constraint_RequestMethodTypeList.clear();
    ...
    } //-- void setConstraint_RequestMethodType(nl.b3p.xml.ows.v100.Constraint_RequestMethodType) 
