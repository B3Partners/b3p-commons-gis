...
public class ResponsiblePartySubsetType implements java.io.Serializable {
     ...
     */
    private nl.b3p.xml.ows.v100.serviceprovider.ContactInfo _contactInfo;
     ...
     */
    private nl.b3p.xml.ows.v100.serviceprovider.Role _role;
    ...
    public ResponsiblePartySubsetType() 
     {
        super();
    } //-- nl.b3p.xml.ows.v100.serviceprovider.ResponsiblePartySubsetType()
     ...
     */
    public nl.b3p.xml.ows.v100.serviceprovider.ContactInfo getContactInfo()
    {
        return this._contactInfo;
    } //-- nl.b3p.xml.ows.v100.serviceprovider.ContactInfo getContactInfo() 
     ...
     */
    public nl.b3p.xml.ows.v100.serviceprovider.Role getRole()
    {
        return this._role;
    } //-- nl.b3p.xml.ows.v100.serviceprovider.Role getRole() 
     ...
     */
    public void setContactInfo(nl.b3p.xml.ows.v100.serviceprovider.ContactInfo contactInfo)
    {
        this._contactInfo = contactInfo;
    } //-- void setContactInfo(nl.b3p.xml.ows.v100.serviceprovider.ContactInfo) 
     ...
     */
    public void setRole(nl.b3p.xml.ows.v100.serviceprovider.Role role)
    {
        this._role = role;
    } //-- void setRole(nl.b3p.xml.ows.v100.serviceprovider.Role) 
     ...
     */
    public static nl.b3p.xml.ows.v100.serviceprovider.ResponsiblePartySubsetType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.serviceprovider.ResponsiblePartySubsetType) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.serviceprovider.ResponsiblePartySubsetType.class, reader);
    } //-- nl.b3p.xml.ows.v100.serviceprovider.ResponsiblePartySubsetType unmarshal(java.io.Reader) 
