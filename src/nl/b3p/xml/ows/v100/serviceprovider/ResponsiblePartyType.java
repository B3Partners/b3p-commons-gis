...
public class ResponsiblePartyType implements java.io.Serializable {
    ...
    public ResponsiblePartyType() 
     {
        super();
    } //-- nl.b3p.xml.ows.v100.serviceprovider.ResponsiblePartyType()
     ...
     */
    public static nl.b3p.xml.ows.v100.serviceprovider.ResponsiblePartyType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.serviceprovider.ResponsiblePartyType) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.serviceprovider.ResponsiblePartyType.class, reader);
    } //-- nl.b3p.xml.ows.v100.serviceprovider.ResponsiblePartyType unmarshal(java.io.Reader) 
