...
public class ServiceProvider implements java.io.Serializable {
     ...
     * provider. 
     */
    private nl.b3p.xml.ows.v100.serviceprovider.ProviderSite _providerSite;
     ...
     * provider. 
     */
    private nl.b3p.xml.ows.v100.serviceprovider.ServiceContact _serviceContact;
    ...
    public ServiceProvider() 
     {
        super();
    } //-- nl.b3p.xml.ows.v100.serviceprovider.ServiceProvider()
     ...
     */
    public nl.b3p.xml.ows.v100.serviceprovider.ProviderSite getProviderSite()
    {
        return this._providerSite;
    } //-- nl.b3p.xml.ows.v100.serviceprovider.ProviderSite getProviderSite() 
     ...
     */
    public nl.b3p.xml.ows.v100.serviceprovider.ServiceContact getServiceContact()
    {
        return this._serviceContact;
    } //-- nl.b3p.xml.ows.v100.serviceprovider.ServiceContact getServiceContact() 
     ...
     */
    public void setProviderSite(nl.b3p.xml.ows.v100.serviceprovider.ProviderSite providerSite)
    {
        this._providerSite = providerSite;
    } //-- void setProviderSite(nl.b3p.xml.ows.v100.serviceprovider.ProviderSite) 
     ...
     */
    public void setServiceContact(nl.b3p.xml.ows.v100.serviceprovider.ServiceContact serviceContact)
    {
        this._serviceContact = serviceContact;
    } //-- void setServiceContact(nl.b3p.xml.ows.v100.serviceprovider.ServiceContact) 
     ...
     */
    public static nl.b3p.xml.ows.v100.serviceprovider.ServiceProvider unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.serviceprovider.ServiceProvider) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.serviceprovider.ServiceProvider.class, reader);
    } //-- nl.b3p.xml.ows.v100.serviceprovider.ServiceProvider unmarshal(java.io.Reader) 
