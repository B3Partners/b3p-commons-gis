...
public class ContactType implements java.io.Serializable {
     ...
     * may be contacted. 
     */
    private nl.b3p.xml.ows.v100.serviceprovider.Phone _phone;

    /**
     * Physical and email address at which the organization or
     * individual may be contacted. 
     */
    private nl.b3p.xml.ows.v100.serviceprovider.Address _address;
     ...
     * not be used. 
     */
    private nl.b3p.xml.ows.v100.serviceprovider.OnlineResource _onlineResource;
    ...
    public ContactType() 
     {
        super();
    } //-- nl.b3p.xml.ows.v100.serviceprovider.ContactType()
     ...
     */
    public nl.b3p.xml.ows.v100.serviceprovider.Address getAddress()
    {
        return this._address;
    } //-- nl.b3p.xml.ows.v100.serviceprovider.Address getAddress() 
     ...
     */
    public nl.b3p.xml.ows.v100.serviceprovider.OnlineResource getOnlineResource()
    {
        return this._onlineResource;
    } //-- nl.b3p.xml.ows.v100.serviceprovider.OnlineResource getOnlineResource() 
     ...
     */
    public nl.b3p.xml.ows.v100.serviceprovider.Phone getPhone()
    {
        return this._phone;
    } //-- nl.b3p.xml.ows.v100.serviceprovider.Phone getPhone() 
     ...
     */
    public void setAddress(nl.b3p.xml.ows.v100.serviceprovider.Address address)
    {
        this._address = address;
    } //-- void setAddress(nl.b3p.xml.ows.v100.serviceprovider.Address) 
     ...
     */
    public void setOnlineResource(nl.b3p.xml.ows.v100.serviceprovider.OnlineResource onlineResource)
    {
        this._onlineResource = onlineResource;
    } //-- void setOnlineResource(nl.b3p.xml.ows.v100.serviceprovider.OnlineResource) 
     ...
     */
    public void setPhone(nl.b3p.xml.ows.v100.serviceprovider.Phone phone)
    {
        this._phone = phone;
    } //-- void setPhone(nl.b3p.xml.ows.v100.serviceprovider.Phone) 
     ...
     * @return ContactType
     */
    public static nl.b3p.xml.ows.v100.serviceprovider.ContactType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.serviceprovider.ContactType) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.serviceprovider.ContactType.class, reader);
    } //-- nl.b3p.xml.ows.v100.serviceprovider.ContactType unmarshal(java.io.Reader) 
