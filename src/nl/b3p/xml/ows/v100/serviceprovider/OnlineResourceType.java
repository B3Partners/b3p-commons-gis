...
public class OnlineResourceType implements java.io.Serializable {
    ...
    public OnlineResourceType() 
     {
        super();
        setType("simple");
    } //-- nl.b3p.xml.ows.v100.serviceprovider.OnlineResourceType()
     ...
     */
    public static nl.b3p.xml.ows.v100.serviceprovider.OnlineResourceType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.serviceprovider.OnlineResourceType) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.serviceprovider.OnlineResourceType.class, reader);
    } //-- nl.b3p.xml.ows.v100.serviceprovider.OnlineResourceType unmarshal(java.io.Reader) 
