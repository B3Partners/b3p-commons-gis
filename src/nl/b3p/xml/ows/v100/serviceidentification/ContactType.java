...
public class ContactType implements java.io.Serializable {
     ...
     * may be contacted. 
     */
    private nl.b3p.xml.ows.v100.serviceidentification.Phone _phone;

    /**
     * Physical and email address at which the organization or
     * individual may be contacted. 
     */
    private nl.b3p.xml.ows.v100.serviceidentification.Address _address;
     ...
     * not be used. 
     */
    private nl.b3p.xml.ows.v100.serviceidentification.OnlineResource _onlineResource;
    ...
    public ContactType() 
     {
        super();
    } //-- nl.b3p.xml.ows.v100.serviceidentification.ContactType()
     ...
     */
    public nl.b3p.xml.ows.v100.serviceidentification.Address getAddress()
    {
        return this._address;
    } //-- nl.b3p.xml.ows.v100.serviceidentification.Address getAddress() 
     ...
     */
    public nl.b3p.xml.ows.v100.serviceidentification.OnlineResource getOnlineResource()
    {
        return this._onlineResource;
    } //-- nl.b3p.xml.ows.v100.serviceidentification.OnlineResource getOnlineResource() 
     ...
     */
    public nl.b3p.xml.ows.v100.serviceidentification.Phone getPhone()
    {
        return this._phone;
    } //-- nl.b3p.xml.ows.v100.serviceidentification.Phone getPhone() 
     ...
     */
    public void setAddress(nl.b3p.xml.ows.v100.serviceidentification.Address address)
    {
        this._address = address;
    } //-- void setAddress(nl.b3p.xml.ows.v100.serviceidentification.Address) 
     ...
     */
    public void setOnlineResource(nl.b3p.xml.ows.v100.serviceidentification.OnlineResource onlineResource)
    {
        this._onlineResource = onlineResource;
    } //-- void setOnlineResource(nl.b3p.xml.ows.v100.serviceidentification.OnlineResource) 
     ...
     */
    public void setPhone(nl.b3p.xml.ows.v100.serviceidentification.Phone phone)
    {
        this._phone = phone;
    } //-- void setPhone(nl.b3p.xml.ows.v100.serviceidentification.Phone) 
     ...
     * @return ContactType
     */
    public static nl.b3p.xml.ows.v100.serviceidentification.ContactType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.serviceidentification.ContactType) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.serviceidentification.ContactType.class, reader);
    } //-- nl.b3p.xml.ows.v100.serviceidentification.ContactType unmarshal(java.io.Reader) 
