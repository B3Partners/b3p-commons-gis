 ...
 */
public class IdentificationType extends nl.b3p.xml.ows.v100.serviceidentification.DescriptionType 
implements java.io.Serializable
{
     ...
     */
    private nl.b3p.xml.ows.v100.serviceidentification.Identifier _identifier;
    ...
    } //-- nl.b3p.xml.ows.v100.serviceidentification.IdentificationType()
     ...
     * @param vBoundingBox
     */
    public void addBoundingBox(nl.b3p.xml.ows.v100.serviceidentification.BoundingBox vBoundingBox)
        throws java.lang.IndexOutOfBoundsException
    {
        _boundingBoxList.add(vBoundingBox);
    } //-- void addBoundingBox(nl.b3p.xml.ows.v100.serviceidentification.BoundingBox) 
     ...
     * @param vBoundingBox
     */
    public void addBoundingBox(int index, nl.b3p.xml.ows.v100.serviceidentification.BoundingBox vBoundingBox)
        throws java.lang.IndexOutOfBoundsException
    {
        _boundingBoxList.add(index, vBoundingBox);
    } //-- void addBoundingBox(int, nl.b3p.xml.ows.v100.serviceidentification.BoundingBox) 
     ...
     * @param vMetadata
     */
    public void addMetadata(nl.b3p.xml.ows.v100.serviceidentification.Metadata vMetadata)
        throws java.lang.IndexOutOfBoundsException
    {
        _metadataList.add(vMetadata);
    } //-- void addMetadata(nl.b3p.xml.ows.v100.serviceidentification.Metadata) 
     ...
     * @param vMetadata
     */
    public void addMetadata(int index, nl.b3p.xml.ows.v100.serviceidentification.Metadata vMetadata)
        throws java.lang.IndexOutOfBoundsException
    {
        _metadataList.add(index, vMetadata);
    } //-- void addMetadata(int, nl.b3p.xml.ows.v100.serviceidentification.Metadata) 
     ...
     * @return BoundingBox
     */
    public nl.b3p.xml.ows.v100.serviceidentification.BoundingBox getBoundingBox(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        ...
        return (nl.b3p.xml.ows.v100.serviceidentification.BoundingBox) _boundingBoxList.get(index);
    } //-- nl.b3p.xml.ows.v100.serviceidentification.BoundingBox getBoundingBox(int) 
     ...
     * @return BoundingBox
     */
    public nl.b3p.xml.ows.v100.serviceidentification.BoundingBox[] getBoundingBox()
    {
        int size = _boundingBoxList.size();
        nl.b3p.xml.ows.v100.serviceidentification.BoundingBox[] mArray = new nl.b3p.xml.ows.v100.serviceidentification.BoundingBox[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (nl.b3p.xml.ows.v100.serviceidentification.BoundingBox) _boundingBoxList.get(index);
        }
        return mArray;
    } //-- nl.b3p.xml.ows.v100.serviceidentification.BoundingBox[] getBoundingBox() 
     ...
     */
    public nl.b3p.xml.ows.v100.serviceidentification.Identifier getIdentifier()
    {
        return this._identifier;
    } //-- nl.b3p.xml.ows.v100.serviceidentification.Identifier getIdentifier() 
     ...
     * @return Metadata
     */
    public nl.b3p.xml.ows.v100.serviceidentification.Metadata getMetadata(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        ...
        return (nl.b3p.xml.ows.v100.serviceidentification.Metadata) _metadataList.get(index);
    } //-- nl.b3p.xml.ows.v100.serviceidentification.Metadata getMetadata(int) 
     ...
     * @return Metadata
     */
    public nl.b3p.xml.ows.v100.serviceidentification.Metadata[] getMetadata()
    {
        int size = _metadataList.size();
        nl.b3p.xml.ows.v100.serviceidentification.Metadata[] mArray = new nl.b3p.xml.ows.v100.serviceidentification.Metadata[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (nl.b3p.xml.ows.v100.serviceidentification.Metadata) _metadataList.get(index);
        }
        return mArray;
    } //-- nl.b3p.xml.ows.v100.serviceidentification.Metadata[] getMetadata() 
     ...
     * @return boolean
     */
    public boolean removeBoundingBox(nl.b3p.xml.ows.v100.serviceidentification.BoundingBox vBoundingBox)
    {
        boolean removed = _boundingBoxList.remove(vBoundingBox);
        return removed;
    } //-- boolean removeBoundingBox(nl.b3p.xml.ows.v100.serviceidentification.BoundingBox) 
     ...
     * @return boolean
     */
    public boolean removeMetadata(nl.b3p.xml.ows.v100.serviceidentification.Metadata vMetadata)
    {
        boolean removed = _metadataList.remove(vMetadata);
        return removed;
    } //-- boolean removeMetadata(nl.b3p.xml.ows.v100.serviceidentification.Metadata) 
     ...
     * @param vBoundingBox
     */
    public void setBoundingBox(int index, nl.b3p.xml.ows.v100.serviceidentification.BoundingBox vBoundingBox)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index >= _boundingBoxList.size())) {
    ...
    } //-- void setBoundingBox(int, nl.b3p.xml.ows.v100.serviceidentification.BoundingBox) 
     ...
     */
    public void setBoundingBox(nl.b3p.xml.ows.v100.serviceidentification.BoundingBox[] boundingBoxArray)
    {
        //-- copy array
        _boundingBoxList.clear();
    ...
    } //-- void setBoundingBox(nl.b3p.xml.ows.v100.serviceidentification.BoundingBox) 
     ...
     */
    public void setIdentifier(nl.b3p.xml.ows.v100.serviceidentification.Identifier identifier)
    {
        this._identifier = identifier;
    } //-- void setIdentifier(nl.b3p.xml.ows.v100.serviceidentification.Identifier) 
     ...
     * @param vMetadata
     */
    public void setMetadata(int index, nl.b3p.xml.ows.v100.serviceidentification.Metadata vMetadata)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index >= _metadataList.size())) {
    ...
    } //-- void setMetadata(int, nl.b3p.xml.ows.v100.serviceidentification.Metadata) 
     ...
     * @param metadataArray
     */
    public void setMetadata(nl.b3p.xml.ows.v100.serviceidentification.Metadata[] metadataArray)
    {
        //-- copy array
        _metadataList.clear();
    ...
    } //-- void setMetadata(nl.b3p.xml.ows.v100.serviceidentification.Metadata) 
    ...
    public static nl.b3p.xml.ows.v100.serviceidentification.DescriptionType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.serviceidentification.DescriptionType) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.serviceidentification.IdentificationType.class, reader);
