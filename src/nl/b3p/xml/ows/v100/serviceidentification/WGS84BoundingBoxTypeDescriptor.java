 ...
 */
public class WGS84BoundingBoxTypeDescriptor extends nl.b3p.xml.ows.v100.serviceidentification.BoundingBoxTypeDescriptor {
    ...
    public WGS84BoundingBoxTypeDescriptor() 
     {
        super();
        setExtendsWithoutFlatten(new nl.b3p.xml.ows.v100.serviceidentification.BoundingBoxTypeDescriptor());
        ...
        desc.setValidator(fieldValidator);
    } //-- nl.b3p.xml.ows.v100.serviceidentification.WGS84BoundingBoxTypeDescriptor()
    ...
    {
        return nl.b3p.xml.ows.v100.serviceidentification.WGS84BoundingBoxType.class;
