...
public class ResponsiblePartySubsetType implements java.io.Serializable {
     ...
     */
    private nl.b3p.xml.ows.v100.serviceidentification.ContactInfo _contactInfo;
     ...
     */
    private nl.b3p.xml.ows.v100.serviceidentification.Role _role;
    ...
    public ResponsiblePartySubsetType() 
     {
        super();
    } //-- nl.b3p.xml.ows.v100.serviceidentification.ResponsiblePartySubsetType()
     ...
     */
    public nl.b3p.xml.ows.v100.serviceidentification.ContactInfo getContactInfo()
    {
        return this._contactInfo;
    } //-- nl.b3p.xml.ows.v100.serviceidentification.ContactInfo getContactInfo() 
     ...
     */
    public nl.b3p.xml.ows.v100.serviceidentification.Role getRole()
    {
        return this._role;
    } //-- nl.b3p.xml.ows.v100.serviceidentification.Role getRole() 
     ...
     */
    public void setContactInfo(nl.b3p.xml.ows.v100.serviceidentification.ContactInfo contactInfo)
    {
        this._contactInfo = contactInfo;
    } //-- void setContactInfo(nl.b3p.xml.ows.v100.serviceidentification.ContactInfo) 
     ...
     */
    public void setRole(nl.b3p.xml.ows.v100.serviceidentification.Role role)
    {
        this._role = role;
    } //-- void setRole(nl.b3p.xml.ows.v100.serviceidentification.Role) 
     ...
     */
    public static nl.b3p.xml.ows.v100.serviceidentification.ResponsiblePartySubsetType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.serviceidentification.ResponsiblePartySubsetType) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.serviceidentification.ResponsiblePartySubsetType.class, reader);
    } //-- nl.b3p.xml.ows.v100.serviceidentification.ResponsiblePartySubsetType unmarshal(java.io.Reader) 
