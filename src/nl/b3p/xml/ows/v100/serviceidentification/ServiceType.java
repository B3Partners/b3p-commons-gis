...
implements java.io.Serializable
{
    ...
    public ServiceType() 
     {
        super();
    } //-- nl.b3p.xml.ows.v100.serviceidentification.ServiceType()
    ...
    public static nl.b3p.xml.ows.v100.serviceidentification.CodeType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.serviceidentification.CodeType) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.serviceidentification.ServiceType.class, reader);
