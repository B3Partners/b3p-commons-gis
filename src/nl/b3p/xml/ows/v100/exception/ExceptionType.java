...
public class ExceptionType implements java.io.Serializable {
    ...
    } //-- nl.b3p.xml.ows.v100.exception.ExceptionType()
    ...
    public static nl.b3p.xml.ows.v100.exception.ExceptionType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.exception.ExceptionType) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.exception.ExceptionType.class, reader);
