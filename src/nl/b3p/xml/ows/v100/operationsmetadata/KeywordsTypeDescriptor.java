...
public class KeywordsTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public KeywordsTypeDescriptor() 
     {
        ...
        //-- _type
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(nl.b3p.xml.ows.v100.operationsmetadata.Type.class, "_type", "Type", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    KeywordsType target = (KeywordsType) object;
                    target.setType( (nl.b3p.xml.ows.v100.operationsmetadata.Type) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new nl.b3p.xml.ows.v100.operationsmetadata.Type();
            }
        };
        desc.setHandler(handler);
        desc.setNameSpaceURI("http://www.opengis.net/ows");
        ...
        desc.setValidator(fieldValidator);
    } //-- nl.b3p.xml.ows.v100.operationsmetadata.KeywordsTypeDescriptor()
    ...
    {
        return nl.b3p.xml.ows.v100.operationsmetadata.KeywordsType.class;
