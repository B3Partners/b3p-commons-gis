 ...
 */
public class WGS84BoundingBoxTypeDescriptor extends nl.b3p.xml.ows.v100.operationsmetadata.BoundingBoxTypeDescriptor {
    ...
    public WGS84BoundingBoxTypeDescriptor() 
     {
        super();
        setExtendsWithoutFlatten(new nl.b3p.xml.ows.v100.operationsmetadata.BoundingBoxTypeDescriptor());
        ...
        desc.setValidator(fieldValidator);
    } //-- nl.b3p.xml.ows.v100.operationsmetadata.WGS84BoundingBoxTypeDescriptor()
    ...
    {
        return nl.b3p.xml.ows.v100.operationsmetadata.WGS84BoundingBoxType.class;
