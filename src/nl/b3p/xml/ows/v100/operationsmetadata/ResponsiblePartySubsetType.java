...
public class ResponsiblePartySubsetType implements java.io.Serializable {
     ...
     */
    private nl.b3p.xml.ows.v100.operationsmetadata.ContactInfo _contactInfo;
     ...
     */
    private nl.b3p.xml.ows.v100.operationsmetadata.Role _role;
    ...
    public ResponsiblePartySubsetType() 
     {
        super();
    } //-- nl.b3p.xml.ows.v100.operationsmetadata.ResponsiblePartySubsetType()
     ...
     */
    public nl.b3p.xml.ows.v100.operationsmetadata.ContactInfo getContactInfo()
    {
        return this._contactInfo;
    } //-- nl.b3p.xml.ows.v100.operationsmetadata.ContactInfo getContactInfo() 
     ...
     */
    public nl.b3p.xml.ows.v100.operationsmetadata.Role getRole()
    {
        return this._role;
    } //-- nl.b3p.xml.ows.v100.operationsmetadata.Role getRole() 
     ...
     */
    public void setContactInfo(nl.b3p.xml.ows.v100.operationsmetadata.ContactInfo contactInfo)
    {
        this._contactInfo = contactInfo;
    } //-- void setContactInfo(nl.b3p.xml.ows.v100.operationsmetadata.ContactInfo) 
     ...
     */
    public void setRole(nl.b3p.xml.ows.v100.operationsmetadata.Role role)
    {
        this._role = role;
    } //-- void setRole(nl.b3p.xml.ows.v100.operationsmetadata.Role) 
     ...
     */
    public static nl.b3p.xml.ows.v100.operationsmetadata.ResponsiblePartySubsetType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.operationsmetadata.ResponsiblePartySubsetType) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.operationsmetadata.ResponsiblePartySubsetType.class, reader);
    } //-- nl.b3p.xml.ows.v100.operationsmetadata.ResponsiblePartySubsetType unmarshal(java.io.Reader) 
