...
implements java.io.Serializable
{
    ...
    public Constraint_Operation() 
     {
        super();
    } //-- nl.b3p.xml.ows.v100.operationsmetadata.Constraint_Operation()
    ...
    public static nl.b3p.xml.ows.v100.operationsmetadata.DomainType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.operationsmetadata.DomainType) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.operationsmetadata.Constraint_Operation.class, reader);
