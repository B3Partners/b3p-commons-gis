...
public class ResponsiblePartySubsetTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ResponsiblePartySubsetTypeDescriptor() 
     {
        ...
        desc.setValidator(fieldValidator);
    } //-- nl.b3p.xml.ows.v100.operationsmetadata.ResponsiblePartySubsetTypeDescriptor()
    ...
    {
        return nl.b3p.xml.ows.v100.operationsmetadata.ResponsiblePartySubsetType.class;
