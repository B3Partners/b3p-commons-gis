...
public class ContactType implements java.io.Serializable {
     ...
     * may be contacted. 
     */
    private nl.b3p.xml.ows.v100.operationsmetadata.Phone _phone;

    /**
     * Physical and email address at which the organization or
     * individual may be contacted. 
     */
    private nl.b3p.xml.ows.v100.operationsmetadata.Address _address;
     ...
     * not be used. 
     */
    private nl.b3p.xml.ows.v100.operationsmetadata.OnlineResource _onlineResource;
    ...
    public ContactType() 
     {
        super();
    } //-- nl.b3p.xml.ows.v100.operationsmetadata.ContactType()
     ...
     */
    public nl.b3p.xml.ows.v100.operationsmetadata.Address getAddress()
    {
        return this._address;
    } //-- nl.b3p.xml.ows.v100.operationsmetadata.Address getAddress() 
     ...
     */
    public nl.b3p.xml.ows.v100.operationsmetadata.OnlineResource getOnlineResource()
    {
        return this._onlineResource;
    } //-- nl.b3p.xml.ows.v100.operationsmetadata.OnlineResource getOnlineResource() 
     ...
     */
    public nl.b3p.xml.ows.v100.operationsmetadata.Phone getPhone()
    {
        return this._phone;
    } //-- nl.b3p.xml.ows.v100.operationsmetadata.Phone getPhone() 
     ...
     */
    public void setAddress(nl.b3p.xml.ows.v100.operationsmetadata.Address address)
    {
        this._address = address;
    } //-- void setAddress(nl.b3p.xml.ows.v100.operationsmetadata.Address) 
     ...
     */
    public void setOnlineResource(nl.b3p.xml.ows.v100.operationsmetadata.OnlineResource onlineResource)
    {
        this._onlineResource = onlineResource;
    } //-- void setOnlineResource(nl.b3p.xml.ows.v100.operationsmetadata.OnlineResource) 
     ...
     */
    public void setPhone(nl.b3p.xml.ows.v100.operationsmetadata.Phone phone)
    {
        this._phone = phone;
    } //-- void setPhone(nl.b3p.xml.ows.v100.operationsmetadata.Phone) 
     ...
     * @return ContactType
     */
    public static nl.b3p.xml.ows.v100.operationsmetadata.ContactType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.operationsmetadata.ContactType) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.operationsmetadata.ContactType.class, reader);
    } //-- nl.b3p.xml.ows.v100.operationsmetadata.ContactType unmarshal(java.io.Reader) 
