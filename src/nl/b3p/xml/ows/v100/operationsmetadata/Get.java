...
/**
 * Connect point URL prefix and any constraints for the HTTP "Get"
 * request method for this operation request. 
 * 
 * @version $Revision$ $Date$
 */
public class Get extends RequestMethodType 
implements java.io.Serializable
{
    ...
    public Get() 
     {
        super();
    } //-- nl.b3p.xml.ows.v100.operationsmetadata.Get()
    ...
    public static nl.b3p.xml.ows.v100.operationsmetadata.OnlineResourceType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.operationsmetadata.OnlineResourceType) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.operationsmetadata.Get.class, reader);
