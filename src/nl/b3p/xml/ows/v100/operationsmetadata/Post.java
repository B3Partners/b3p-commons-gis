...
implements java.io.Serializable
{
    ...
    public Post() 
     {
        super();
    } //-- nl.b3p.xml.ows.v100.operationsmetadata.Post()
    ...
    public static nl.b3p.xml.ows.v100.operationsmetadata.OnlineResourceType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.operationsmetadata.OnlineResourceType) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.operationsmetadata.Post.class, reader);
