...
public class ResponsiblePartySubsetType implements java.io.Serializable {
     ...
     */
    private nl.b3p.xml.ows.v100.subset19115.ContactInfo _contactInfo;
     ...
     */
    private nl.b3p.xml.ows.v100.subset19115.Role _role;
    ...
    public ResponsiblePartySubsetType() 
     {
        super();
    } //-- nl.b3p.xml.ows.v100.subset19115.ResponsiblePartySubsetType()
     ...
     */
    public nl.b3p.xml.ows.v100.subset19115.ContactInfo getContactInfo()
    {
        return this._contactInfo;
    } //-- nl.b3p.xml.ows.v100.subset19115.ContactInfo getContactInfo() 
     ...
     */
    public nl.b3p.xml.ows.v100.subset19115.Role getRole()
    {
        return this._role;
    } //-- nl.b3p.xml.ows.v100.subset19115.Role getRole() 
     ...
     */
    public void setContactInfo(nl.b3p.xml.ows.v100.subset19115.ContactInfo contactInfo)
    {
        this._contactInfo = contactInfo;
    } //-- void setContactInfo(nl.b3p.xml.ows.v100.subset19115.ContactInfo) 
     ...
     */
    public void setRole(nl.b3p.xml.ows.v100.subset19115.Role role)
    {
        this._role = role;
    } //-- void setRole(nl.b3p.xml.ows.v100.subset19115.Role) 
     ...
     */
    public static nl.b3p.xml.ows.v100.subset19115.ResponsiblePartySubsetType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.subset19115.ResponsiblePartySubsetType) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.subset19115.ResponsiblePartySubsetType.class, reader);
    } //-- nl.b3p.xml.ows.v100.subset19115.ResponsiblePartySubsetType unmarshal(java.io.Reader) 
