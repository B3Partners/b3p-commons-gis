...
public class MappingDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public MappingDescriptor() 
     {
        ...
        //-- _featureTypeList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(nl.b3p.gis.mapping.FeatureType.class, "_featureTypeList", "featureType", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    Mapping target = (Mapping) object;
                    target.addFeatureType( (nl.b3p.gis.mapping.FeatureType) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new nl.b3p.gis.mapping.FeatureType();
            }
        };
        desc.setHandler(handler);
        ...
        desc.setValidator(fieldValidator);
    } //-- nl.b3p.gis.mapping.MappingDescriptor()
    ...
    {
        return nl.b3p.gis.mapping.Mapping.class;
