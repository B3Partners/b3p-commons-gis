...
implements java.io.Serializable
{
    ...
    public PropertyName() 
     {
        super();
    } //-- nl.b3p.xml.ogc.v100.expr.PropertyName()
    ...
    public static nl.b3p.xml.ogc.v100.expr.ExpressionType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ogc.v100.expr.ExpressionType) Unmarshaller.unmarshal(nl.b3p.xml.ogc.v100.expr.PropertyName.class, reader);
