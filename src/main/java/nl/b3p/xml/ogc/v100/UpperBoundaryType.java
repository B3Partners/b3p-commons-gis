...
public class UpperBoundaryType implements java.io.Serializable {
    ...
    public UpperBoundaryType() 
     {
        super();
    } //-- nl.b3p.xml.ogc.v100.UpperBoundaryType()
    ...
    public static nl.b3p.xml.ogc.v100.UpperBoundaryType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ogc.v100.UpperBoundaryType) Unmarshaller.unmarshal(nl.b3p.xml.ogc.v100.UpperBoundaryType.class, reader);
