...
public class LowerBoundaryType implements java.io.Serializable {
    ...
    public LowerBoundaryType() 
     {
        super();
    } //-- nl.b3p.xml.ogc.v100.LowerBoundaryType()
    ...
    public static nl.b3p.xml.ogc.v100.LowerBoundaryType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ogc.v100.LowerBoundaryType) Unmarshaller.unmarshal(nl.b3p.xml.ogc.v100.LowerBoundaryType.class, reader);
