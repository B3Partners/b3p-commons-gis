 ...
 */
public class DistanceBufferType extends nl.b3p.xml.ogc.v100.SpatialOpsType 
implements java.io.Serializable
{
     ...
     * Field _distance
     */
    private nl.b3p.xml.ogc.v100.Distance _distance;
    ...
    public DistanceBufferType() 
     {
        super();
    } //-- nl.b3p.xml.ogc.v100.DistanceBufferType()
     ...
     */
    public nl.b3p.xml.ogc.v100.Distance getDistance()
    {
        return this._distance;
    } //-- nl.b3p.xml.ogc.v100.Distance getDistance() 
     ...
     */
    public void setDistance(nl.b3p.xml.ogc.v100.Distance distance)
    {
        this._distance = distance;
    } //-- void setDistance(nl.b3p.xml.ogc.v100.Distance) 
    ...
    public static nl.b3p.xml.ogc.v100.SpatialOpsType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ogc.v100.SpatialOpsType) Unmarshaller.unmarshal(nl.b3p.xml.ogc.v100.DistanceBufferType.class, reader);
