 ...
 */
public class PropertyIsEqualTo extends BinaryComparisonOpType 
implements java.io.Serializable
{
    ...
    public PropertyIsEqualTo() 
     {
        super();
    } //-- nl.b3p.xml.ogc.v100.PropertyIsEqualTo()
    ...
    public static nl.b3p.xml.ogc.v100.ComparisonOpsType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ogc.v100.ComparisonOpsType) Unmarshaller.unmarshal(nl.b3p.xml.ogc.v100.PropertyIsEqualTo.class, reader);
