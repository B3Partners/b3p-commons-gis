...
implements java.io.Serializable
{
    ...
    public ArithmeticOperators() 
     {
        super();
    } //-- nl.b3p.xml.ogc.v110.capabilities.ArithmeticOperators()
    ...
    public static nl.b3p.xml.ogc.v110.capabilities.ArithmeticOperatorsType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ogc.v110.capabilities.ArithmeticOperatorsType) Unmarshaller.unmarshal(nl.b3p.xml.ogc.v110.capabilities.ArithmeticOperators.class, reader);
