...
implements java.io.Serializable
{
    ...
    public ComparisonOperators() 
     {
        super();
    } //-- nl.b3p.xml.ogc.v110.ComparisonOperators()
    ...
    public static nl.b3p.xml.ogc.v110.ComparisonOperatorsType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ogc.v110.ComparisonOperatorsType) Unmarshaller.unmarshal(nl.b3p.xml.ogc.v110.ComparisonOperators.class, reader);
