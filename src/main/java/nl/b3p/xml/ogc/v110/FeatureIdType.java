 ...
 */
public class FeatureIdType extends nl.b3p.xml.ogc.v110.AbstractIdType 
implements java.io.Serializable
{
    ...
    public FeatureIdType() 
     {
        super();
    } //-- nl.b3p.xml.ogc.v110.FeatureIdType()
    ...
    public static nl.b3p.xml.ogc.v110.AbstractIdType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ogc.v110.AbstractIdType) Unmarshaller.unmarshal(nl.b3p.xml.ogc.v110.FeatureIdType.class, reader);
