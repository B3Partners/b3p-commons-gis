 ...
 */
public class LiteralTypeDescriptor extends nl.b3p.xml.ogc.v110.sort.ExpressionTypeDescriptor {
    ...
    public LiteralTypeDescriptor() 
     {
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                LiteralType target = (LiteralType) object;
        ...
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        desc.setValidator(fieldValidator);
    } //-- nl.b3p.xml.ogc.v110.sort.LiteralTypeDescriptor()
    ...
    {
        return nl.b3p.xml.ogc.v110.sort.LiteralType.class;
