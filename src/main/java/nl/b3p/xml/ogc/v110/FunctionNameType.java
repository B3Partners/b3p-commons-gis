...
public class FunctionNameType implements java.io.Serializable {
    ...
    public FunctionNameType() 
     {
        super();
        setContent("");
    } //-- nl.b3p.xml.ogc.v110.FunctionNameType()
    ...
    public static nl.b3p.xml.ogc.v110.FunctionNameType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ogc.v110.FunctionNameType) Unmarshaller.unmarshal(nl.b3p.xml.ogc.v110.FunctionNameType.class, reader);
