...
public class ArithmeticOperatorsTypeItem implements java.io.Serializable {
     ...
     */
    private nl.b3p.xml.ogc.v110.SimpleArithmetic _simpleArithmetic;

    /**
     * Field _functions
     */
    private nl.b3p.xml.ogc.v110.Functions _functions;
    ...
    public ArithmeticOperatorsTypeItem() 
     {
        super();
    } //-- nl.b3p.xml.ogc.v110.ArithmeticOperatorsTypeItem()
     ...
     */
    public nl.b3p.xml.ogc.v110.Functions getFunctions()
    {
        return this._functions;
    } //-- nl.b3p.xml.ogc.v110.Functions getFunctions() 
     ...
     */
    public nl.b3p.xml.ogc.v110.SimpleArithmetic getSimpleArithmetic()
    {
        return this._simpleArithmetic;
    } //-- nl.b3p.xml.ogc.v110.SimpleArithmetic getSimpleArithmetic() 
     ...
     */
    public void setFunctions(nl.b3p.xml.ogc.v110.Functions functions)
    {
        this._functions = functions;
        this._choiceValue = functions;
    } //-- void setFunctions(nl.b3p.xml.ogc.v110.Functions) 
     ...
     */
    public void setSimpleArithmetic(nl.b3p.xml.ogc.v110.SimpleArithmetic simpleArithmetic)
    {
        this._simpleArithmetic = simpleArithmetic;
        this._choiceValue = simpleArithmetic;
    } //-- void setSimpleArithmetic(nl.b3p.xml.ogc.v110.SimpleArithmetic) 
