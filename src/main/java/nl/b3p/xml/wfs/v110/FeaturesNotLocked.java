...
implements java.io.Serializable
{
    ...
    public FeaturesNotLocked() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v110.FeaturesNotLocked()
    ...
    public static nl.b3p.xml.wfs.v110.FeaturesNotLockedType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v110.FeaturesNotLockedType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v110.FeaturesNotLocked.class, reader);
