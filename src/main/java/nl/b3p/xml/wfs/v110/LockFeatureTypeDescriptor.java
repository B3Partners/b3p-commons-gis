 ...
 */
public class LockFeatureTypeDescriptor extends nl.b3p.xml.wfs.v110.BaseRequestTypeDescriptor {
    ...
    public LockFeatureTypeDescriptor() 
     {
        ...
        //-- _lockAction
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(nl.b3p.xml.wfs.v110.types.AllSomeType.class, "_lockAction", "lockAction", org.exolab.castor.xml.NodeType.Attribute);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    LockFeatureType target = (LockFeatureType) object;
                    target.setLockAction( (nl.b3p.xml.wfs.v110.types.AllSomeType) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        //-- _lockList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(nl.b3p.xml.wfs.v110.Lock.class, "_lockList", "Lock", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    LockFeatureType target = (LockFeatureType) object;
                    target.addLock( (nl.b3p.xml.wfs.v110.Lock) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new nl.b3p.xml.wfs.v110.Lock();
            }
        };
        desc.setHandler(handler);
        ...
        desc.setValidator(fieldValidator);
    } //-- nl.b3p.xml.wfs.v110.LockFeatureTypeDescriptor()
    ...
    {
        return nl.b3p.xml.wfs.v110.LockFeatureType.class;
