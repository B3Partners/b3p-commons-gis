 ...
 */
public class TransactionSummary extends TransactionSummaryType 
implements java.io.Serializable
{
    ...
    public TransactionSummary() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v110.TransactionSummary()
    ...
    public static nl.b3p.xml.wfs.v110.TransactionSummaryType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v110.TransactionSummaryType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v110.TransactionSummary.class, reader);
