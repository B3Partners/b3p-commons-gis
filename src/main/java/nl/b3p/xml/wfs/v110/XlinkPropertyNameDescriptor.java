...
/**
 * Class XlinkPropertyNameDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class XlinkPropertyNameDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public XlinkPropertyNameDescriptor() 
     {
        super();
        nsURI = "http://www.opengis.net/wfs";
        xmlName = "XlinkPropertyName";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                XlinkPropertyName target = (XlinkPropertyName) object;
    ...
    } //-- nl.b3p.xml.wfs.v110.XlinkPropertyNameDescriptor()
    ...
    {
        return nl.b3p.xml.wfs.v110.XlinkPropertyName.class;
