 ...
 */
public class TransactionResults extends TransactionResultsType 
implements java.io.Serializable
{
    ...
    public TransactionResults() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v110.TransactionResults()
    ...
    public static nl.b3p.xml.wfs.v110.TransactionResultsType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v110.TransactionResultsType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v110.TransactionResults.class, reader);
