...
implements java.io.Serializable
{
    ...
    public FeaturesLocked() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v110.FeaturesLocked()
    ...
    public static nl.b3p.xml.wfs.v110.FeaturesLockedType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v110.FeaturesLockedType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v110.FeaturesLocked.class, reader);
