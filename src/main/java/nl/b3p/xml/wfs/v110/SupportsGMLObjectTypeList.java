 ...
 */
public class SupportsGMLObjectTypeList extends GMLObjectTypeListType 
implements java.io.Serializable
{
    ...
    public SupportsGMLObjectTypeList() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v110.SupportsGMLObjectTypeList()
    ...
    public static nl.b3p.xml.wfs.v110.GMLObjectTypeListType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v110.GMLObjectTypeListType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v110.SupportsGMLObjectTypeList.class, reader);
