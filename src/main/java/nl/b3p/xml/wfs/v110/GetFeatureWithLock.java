...
implements java.io.Serializable
{
    ...
    public GetFeatureWithLock() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v110.GetFeatureWithLock()
    ...
    public static nl.b3p.xml.wfs.v110.BaseRequestType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v110.BaseRequestType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v110.GetFeatureWithLock.class, reader);
