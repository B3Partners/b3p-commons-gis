...
implements java.io.Serializable
{
    ...
    public Status() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v100.transaction.Status()
    ...
    public static nl.b3p.xml.wfs.v100.transaction.StatusType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v100.transaction.StatusType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v100.transaction.Status.class, reader);
