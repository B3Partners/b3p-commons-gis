...
public class LockFeatureType implements java.io.Serializable {
     ...
     *  
     */
    private nl.b3p.xml.wfs.v100.transaction.types.AllSomeType _lockAction;
    ...
    } //-- nl.b3p.xml.wfs.v100.transaction.LockFeatureType()
     ...
     * @param vLock
     */
    public void addLock(nl.b3p.xml.wfs.v100.transaction.Lock vLock)
        throws java.lang.IndexOutOfBoundsException
    {
        _lockList.add(vLock);
    } //-- void addLock(nl.b3p.xml.wfs.v100.transaction.Lock) 
     ...
     * @param vLock
     */
    public void addLock(int index, nl.b3p.xml.wfs.v100.transaction.Lock vLock)
        throws java.lang.IndexOutOfBoundsException
    {
        _lockList.add(index, vLock);
    } //-- void addLock(int, nl.b3p.xml.wfs.v100.transaction.Lock) 
     ...
     * @return Lock
     */
    public nl.b3p.xml.wfs.v100.transaction.Lock getLock(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        return (nl.b3p.xml.wfs.v100.transaction.Lock) _lockList.get(index);
    } //-- nl.b3p.xml.wfs.v100.transaction.Lock getLock(int) 
     ...
     * @return Lock
     */
    public nl.b3p.xml.wfs.v100.transaction.Lock[] getLock()
    {
        int size = _lockList.size();
        nl.b3p.xml.wfs.v100.transaction.Lock[] mArray = new nl.b3p.xml.wfs.v100.transaction.Lock[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (nl.b3p.xml.wfs.v100.transaction.Lock) _lockList.get(index);
        }
        return mArray;
    } //-- nl.b3p.xml.wfs.v100.transaction.Lock[] getLock() 
     ...
     */
    public nl.b3p.xml.wfs.v100.transaction.types.AllSomeType getLockAction()
    {
        return this._lockAction;
    } //-- nl.b3p.xml.wfs.v100.transaction.types.AllSomeType getLockAction() 
     ...
     * @return boolean
     */
    public boolean removeLock(nl.b3p.xml.wfs.v100.transaction.Lock vLock)
    {
        boolean removed = _lockList.remove(vLock);
        return removed;
    } //-- boolean removeLock(nl.b3p.xml.wfs.v100.transaction.Lock) 
     ...
     * @param vLock
     */
    public void setLock(int index, nl.b3p.xml.wfs.v100.transaction.Lock vLock)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index >= _lockList.size())) {
    ...
    } //-- void setLock(int, nl.b3p.xml.wfs.v100.transaction.Lock) 
     ...
     * @param lockArray
     */
    public void setLock(nl.b3p.xml.wfs.v100.transaction.Lock[] lockArray)
    {
        //-- copy array
        _lockList.clear();
    ...
    } //-- void setLock(nl.b3p.xml.wfs.v100.transaction.Lock) 
     ...
     */
    public void setLockAction(nl.b3p.xml.wfs.v100.transaction.types.AllSomeType lockAction)
    {
        this._lockAction = lockAction;
    } //-- void setLockAction(nl.b3p.xml.wfs.v100.transaction.types.AllSomeType) 
     ...
     */
    public static nl.b3p.xml.wfs.v100.transaction.LockFeatureType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v100.transaction.LockFeatureType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v100.transaction.LockFeatureType.class, reader);
    } //-- nl.b3p.xml.wfs.v100.transaction.LockFeatureType unmarshal(java.io.Reader) 
