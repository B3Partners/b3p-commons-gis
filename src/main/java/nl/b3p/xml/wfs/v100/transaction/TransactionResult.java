 ...
 */
public class TransactionResult extends TransactionResultType 
implements java.io.Serializable
{
    ...
    public TransactionResult() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v100.transaction.TransactionResult()
    ...
    public static nl.b3p.xml.wfs.v100.transaction.TransactionResultType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v100.transaction.TransactionResultType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v100.transaction.TransactionResult.class, reader);
