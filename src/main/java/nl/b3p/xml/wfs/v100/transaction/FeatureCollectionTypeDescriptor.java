 ...
 */
public class FeatureCollectionTypeDescriptor extends nl.b3p.xml.gml.v212.AbstractFeatureCollectionTypeDescriptor {
    ...
    public FeatureCollectionTypeDescriptor() 
     {
        super();
        setExtendsWithoutFlatten(new nl.b3p.xml.gml.v212.AbstractFeatureCollectionTypeDescriptor());
    ...
    } //-- nl.b3p.xml.wfs.v100.transaction.FeatureCollectionTypeDescriptor()
    ...
    {
        return nl.b3p.xml.wfs.v100.transaction.FeatureCollectionType.class;
