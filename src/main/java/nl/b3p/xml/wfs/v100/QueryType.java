...
public class QueryType implements java.io.Serializable {
     ...
     * @return QueryType
     */
    public static nl.b3p.xml.wfs.v100.QueryType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v100.QueryType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v100.QueryType.class, reader);
    } //-- nl.b3p.xml.wfs.v100.QueryType unmarshal(java.io.Reader) 
