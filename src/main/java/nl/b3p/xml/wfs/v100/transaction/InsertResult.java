...
implements java.io.Serializable
{
    ...
    public InsertResult() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v100.transaction.InsertResult()
    ...
    public static nl.b3p.xml.wfs.v100.transaction.InsertResultType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v100.transaction.InsertResultType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v100.transaction.InsertResult.class, reader);
