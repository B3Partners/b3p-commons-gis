...
implements java.io.Serializable
{
    ...
    public Update() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v100.transaction.Update()
    ...
    public static nl.b3p.xml.wfs.v100.transaction.UpdateElementType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v100.transaction.UpdateElementType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v100.transaction.Update.class, reader);
