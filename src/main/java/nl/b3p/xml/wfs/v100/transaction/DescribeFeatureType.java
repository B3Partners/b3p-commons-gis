...
implements java.io.Serializable
{
    ...
    public DescribeFeatureType() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v100.transaction.DescribeFeatureType()
    ...
    public static nl.b3p.xml.wfs.v100.transaction.DescribeFeatureTypeType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v100.transaction.DescribeFeatureTypeType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v100.transaction.DescribeFeatureType.class, reader);
