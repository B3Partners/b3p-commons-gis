...
implements java.io.Serializable
{
    ...
    public Query() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v100.transaction.Query()
    ...
    public static nl.b3p.xml.wfs.v100.transaction.QueryType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v100.transaction.QueryType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v100.transaction.Query.class, reader);
