...
implements java.io.Serializable
{
    ...
    public Lock() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v100.transaction.Lock()
    ...
    public static nl.b3p.xml.wfs.v100.transaction.LockType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v100.transaction.LockType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v100.transaction.Lock.class, reader);
