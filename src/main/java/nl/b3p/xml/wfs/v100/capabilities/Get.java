...
implements java.io.Serializable
{
    ...
    public Get() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v100.capabilities.Get()
    ...
    public static nl.b3p.xml.wfs.v100.capabilities.GetType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v100.capabilities.GetType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v100.capabilities.Get.class, reader);
