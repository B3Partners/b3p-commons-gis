...
public class GetFeatureTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public GetFeatureTypeDescriptor() 
     {
        ...
        //-- _queryList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(nl.b3p.xml.wfs.v100.Query.class, "_queryList", "Query", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    GetFeatureType target = (GetFeatureType) object;
                    target.addQuery( (nl.b3p.xml.wfs.v100.Query) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
        ...
        desc.setValidator(fieldValidator);
    } //-- nl.b3p.xml.wfs.v100.GetFeatureTypeDescriptor()
    ...
    {
        return nl.b3p.xml.wfs.v100.GetFeatureType.class;
