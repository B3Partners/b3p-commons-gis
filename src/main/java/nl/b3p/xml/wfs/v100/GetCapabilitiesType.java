...
public class GetCapabilitiesType implements java.io.Serializable {
    ...
    public GetCapabilitiesType() 
     {
        ...
        setVersion("1.0.0");
        setService("WFS");
    } //-- nl.b3p.xml.wfs.v100.GetCapabilitiesType()
     ...
     */
    public static nl.b3p.xml.wfs.v100.GetCapabilitiesType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v100.GetCapabilitiesType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v100.GetCapabilitiesType.class, reader);
    } //-- nl.b3p.xml.wfs.v100.GetCapabilitiesType unmarshal(java.io.Reader) 
