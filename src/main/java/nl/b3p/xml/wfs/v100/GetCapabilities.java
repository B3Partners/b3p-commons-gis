...
implements java.io.Serializable, nl.b3p.xml.wfs.GetCapabilities
{
    ...
    public GetCapabilities() 
     {
        super();
    } //-- nl.b3p.xml.wfs.v100.GetCapabilities()
    ...
    public static nl.b3p.xml.wfs.v100.GetCapabilitiesType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.wfs.v100.GetCapabilitiesType) Unmarshaller.unmarshal(nl.b3p.xml.wfs.v100.GetCapabilities.class, reader);
