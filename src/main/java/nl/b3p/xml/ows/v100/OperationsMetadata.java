...
public class OperationsMetadata implements java.io.Serializable {
     ...
     */
    public void addConstraint_OperationsMetadata(nl.b3p.xml.ows.v100.Constraint_OperationsMetadata vConstraint_OperationsMetadata)
        throws java.lang.IndexOutOfBoundsException
    {
        _constraint_OperationsMetadataList.add(vConstraint_OperationsMetadata);
    } //-- void addConstraint_OperationsMetadata(nl.b3p.xml.ows.v100.Constraint_OperationsMetadata) 
     ...
     * @param vConstraint_OperationsMetadata
     */
    public void addConstraint_OperationsMetadata(int index, nl.b3p.xml.ows.v100.Constraint_OperationsMetadata vConstraint_OperationsMetadata)
        throws java.lang.IndexOutOfBoundsException
    {
        _constraint_OperationsMetadataList.add(index, vConstraint_OperationsMetadata);
    } //-- void addConstraint_OperationsMetadata(int, nl.b3p.xml.ows.v100.Constraint_OperationsMetadata) 
     ...
     */
    public void addParameter_OperationsMetadata(nl.b3p.xml.ows.v100.Parameter_OperationsMetadata vParameter_OperationsMetadata)
        throws java.lang.IndexOutOfBoundsException
    {
        _parameter_OperationsMetadataList.add(vParameter_OperationsMetadata);
    } //-- void addParameter_OperationsMetadata(nl.b3p.xml.ows.v100.Parameter_OperationsMetadata) 
     ...
     * @param vParameter_OperationsMetadata
     */
    public void addParameter_OperationsMetadata(int index, nl.b3p.xml.ows.v100.Parameter_OperationsMetadata vParameter_OperationsMetadata)
        throws java.lang.IndexOutOfBoundsException
    {
        _parameter_OperationsMetadataList.add(index, vParameter_OperationsMetadata);
    } //-- void addParameter_OperationsMetadata(int, nl.b3p.xml.ows.v100.Parameter_OperationsMetadata) 
     ...
     */
    public nl.b3p.xml.ows.v100.Constraint_OperationsMetadata getConstraint_OperationsMetadata(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        return (nl.b3p.xml.ows.v100.Constraint_OperationsMetadata) _constraint_OperationsMetadataList.get(index);
    } //-- nl.b3p.xml.ows.v100.Constraint_OperationsMetadata getConstraint_OperationsMetadata(int) 
     ...
     * @return Constraint_OperationsMetadata
     */
    public nl.b3p.xml.ows.v100.Constraint_OperationsMetadata[] getConstraint_OperationsMetadata()
    {
        int size = _constraint_OperationsMetadataList.size();
        nl.b3p.xml.ows.v100.Constraint_OperationsMetadata[] mArray = new nl.b3p.xml.ows.v100.Constraint_OperationsMetadata[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (nl.b3p.xml.ows.v100.Constraint_OperationsMetadata) _constraint_OperationsMetadataList.get(index);
        }
        return mArray;
    } //-- nl.b3p.xml.ows.v100.Constraint_OperationsMetadata[] getConstraint_OperationsMetadata() 
     ...
     */
    public nl.b3p.xml.ows.v100.Parameter_OperationsMetadata getParameter_OperationsMetadata(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        ...
        return (nl.b3p.xml.ows.v100.Parameter_OperationsMetadata) _parameter_OperationsMetadataList.get(index);
    } //-- nl.b3p.xml.ows.v100.Parameter_OperationsMetadata getParameter_OperationsMetadata(int) 
     ...
     * @return Parameter_OperationsMetadata
     */
    public nl.b3p.xml.ows.v100.Parameter_OperationsMetadata[] getParameter_OperationsMetadata()
    {
        int size = _parameter_OperationsMetadataList.size();
        nl.b3p.xml.ows.v100.Parameter_OperationsMetadata[] mArray = new nl.b3p.xml.ows.v100.Parameter_OperationsMetadata[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (nl.b3p.xml.ows.v100.Parameter_OperationsMetadata) _parameter_OperationsMetadataList.get(index);
        }
        return mArray;
    } //-- nl.b3p.xml.ows.v100.Parameter_OperationsMetadata[] getParameter_OperationsMetadata() 
     ...
     * @return boolean
     */
    public boolean removeConstraint_OperationsMetadata(nl.b3p.xml.ows.v100.Constraint_OperationsMetadata vConstraint_OperationsMetadata)
    {
        boolean removed = _constraint_OperationsMetadataList.remove(vConstraint_OperationsMetadata);
        return removed;
    } //-- boolean removeConstraint_OperationsMetadata(nl.b3p.xml.ows.v100.Constraint_OperationsMetadata) 
     ...
     * @return boolean
     */
    public boolean removeParameter_OperationsMetadata(nl.b3p.xml.ows.v100.Parameter_OperationsMetadata vParameter_OperationsMetadata)
    {
        boolean removed = _parameter_OperationsMetadataList.remove(vParameter_OperationsMetadata);
        return removed;
    } //-- boolean removeParameter_OperationsMetadata(nl.b3p.xml.ows.v100.Parameter_OperationsMetadata) 
     ...
     * @param vConstraint_OperationsMetadata
     */
    public void setConstraint_OperationsMetadata(int index, nl.b3p.xml.ows.v100.Constraint_OperationsMetadata vConstraint_OperationsMetadata)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index >= _constraint_OperationsMetadataList.size())) {
    ...
    } //-- void setConstraint_OperationsMetadata(int, nl.b3p.xml.ows.v100.Constraint_OperationsMetadata) 
     ...
     */
    public void setConstraint_OperationsMetadata(nl.b3p.xml.ows.v100.Constraint_OperationsMetadata[] constraint_OperationsMetadataArray)
    {
        //-- copy array
        _constraint_OperationsMetadataList.clear();
    ...
    } //-- void setConstraint_OperationsMetadata(nl.b3p.xml.ows.v100.Constraint_OperationsMetadata) 
     ...
     * @param vParameter_OperationsMetadata
     */
    public void setParameter_OperationsMetadata(int index, nl.b3p.xml.ows.v100.Parameter_OperationsMetadata vParameter_OperationsMetadata)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index >= _parameter_OperationsMetadataList.size())) {
    ...
    } //-- void setParameter_OperationsMetadata(int, nl.b3p.xml.ows.v100.Parameter_OperationsMetadata) 
     ...
     */
    public void setParameter_OperationsMetadata(nl.b3p.xml.ows.v100.Parameter_OperationsMetadata[] parameter_OperationsMetadataArray)
    {
        //-- copy array
        _parameter_OperationsMetadataList.clear();
    ...
    } //-- void setParameter_OperationsMetadata(nl.b3p.xml.ows.v100.Parameter_OperationsMetadata) 
