...
public class Operation implements java.io.Serializable {
     ...
     */
    public void addConstraint_Operation(nl.b3p.xml.ows.v100.Constraint_Operation vConstraint_Operation)
        throws java.lang.IndexOutOfBoundsException
    {
        _constraint_OperationList.add(vConstraint_Operation);
    } //-- void addConstraint_Operation(nl.b3p.xml.ows.v100.Constraint_Operation) 
     ...
     * @param vConstraint_Operation
     */
    public void addConstraint_Operation(int index, nl.b3p.xml.ows.v100.Constraint_Operation vConstraint_Operation)
        throws java.lang.IndexOutOfBoundsException
    {
        _constraint_OperationList.add(index, vConstraint_Operation);
    } //-- void addConstraint_Operation(int, nl.b3p.xml.ows.v100.Constraint_Operation) 
     ...
     */
    public void addParameter_Operation(nl.b3p.xml.ows.v100.Parameter_Operation vParameter_Operation)
        throws java.lang.IndexOutOfBoundsException
    {
        _parameter_OperationList.add(vParameter_Operation);
    } //-- void addParameter_Operation(nl.b3p.xml.ows.v100.Parameter_Operation) 
     ...
     * @param vParameter_Operation
     */
    public void addParameter_Operation(int index, nl.b3p.xml.ows.v100.Parameter_Operation vParameter_Operation)
        throws java.lang.IndexOutOfBoundsException
    {
        _parameter_OperationList.add(index, vParameter_Operation);
    } //-- void addParameter_Operation(int, nl.b3p.xml.ows.v100.Parameter_Operation) 
     ...
     */
    public nl.b3p.xml.ows.v100.Constraint_Operation getConstraint_Operation(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        return (nl.b3p.xml.ows.v100.Constraint_Operation) _constraint_OperationList.get(index);
    } //-- nl.b3p.xml.ows.v100.Constraint_Operation getConstraint_Operation(int) 
     ...
     * @return Constraint_Operation
     */
    public nl.b3p.xml.ows.v100.Constraint_Operation[] getConstraint_Operation()
    {
        int size = _constraint_OperationList.size();
        nl.b3p.xml.ows.v100.Constraint_Operation[] mArray = new nl.b3p.xml.ows.v100.Constraint_Operation[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (nl.b3p.xml.ows.v100.Constraint_Operation) _constraint_OperationList.get(index);
        }
        return mArray;
    } //-- nl.b3p.xml.ows.v100.Constraint_Operation[] getConstraint_Operation() 
     ...
     */
    public nl.b3p.xml.ows.v100.Parameter_Operation getParameter_Operation(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        ...
        return (nl.b3p.xml.ows.v100.Parameter_Operation) _parameter_OperationList.get(index);
    } //-- nl.b3p.xml.ows.v100.Parameter_Operation getParameter_Operation(int) 
     ...
     * @return Parameter_Operation
     */
    public nl.b3p.xml.ows.v100.Parameter_Operation[] getParameter_Operation()
    {
        int size = _parameter_OperationList.size();
        nl.b3p.xml.ows.v100.Parameter_Operation[] mArray = new nl.b3p.xml.ows.v100.Parameter_Operation[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (nl.b3p.xml.ows.v100.Parameter_Operation) _parameter_OperationList.get(index);
        }
        return mArray;
    } //-- nl.b3p.xml.ows.v100.Parameter_Operation[] getParameter_Operation() 
     ...
     * @return boolean
     */
    public boolean removeConstraint_Operation(nl.b3p.xml.ows.v100.Constraint_Operation vConstraint_Operation)
    {
        boolean removed = _constraint_OperationList.remove(vConstraint_Operation);
        return removed;
    } //-- boolean removeConstraint_Operation(nl.b3p.xml.ows.v100.Constraint_Operation) 
     ...
     * @return boolean
     */
    public boolean removeParameter_Operation(nl.b3p.xml.ows.v100.Parameter_Operation vParameter_Operation)
    {
        boolean removed = _parameter_OperationList.remove(vParameter_Operation);
        return removed;
    } //-- boolean removeParameter_Operation(nl.b3p.xml.ows.v100.Parameter_Operation) 
     ...
     * @param vConstraint_Operation
     */
    public void setConstraint_Operation(int index, nl.b3p.xml.ows.v100.Constraint_Operation vConstraint_Operation)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index >= _constraint_OperationList.size())) {
    ...
    } //-- void setConstraint_Operation(int, nl.b3p.xml.ows.v100.Constraint_Operation) 
     ...
     */
    public void setConstraint_Operation(nl.b3p.xml.ows.v100.Constraint_Operation[] constraint_OperationArray)
    {
        //-- copy array
        _constraint_OperationList.clear();
    ...
    } //-- void setConstraint_Operation(nl.b3p.xml.ows.v100.Constraint_Operation) 
     ...
     * @param vParameter_Operation
     */
    public void setParameter_Operation(int index, nl.b3p.xml.ows.v100.Parameter_Operation vParameter_Operation)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index >= _parameter_OperationList.size())) {
    ...
    } //-- void setParameter_Operation(int, nl.b3p.xml.ows.v100.Parameter_Operation) 
     ...
     */
    public void setParameter_Operation(nl.b3p.xml.ows.v100.Parameter_Operation[] parameter_OperationArray)
    {
        //-- copy array
        _parameter_OperationList.clear();
    ...
    } //-- void setParameter_Operation(nl.b3p.xml.ows.v100.Parameter_Operation) 
