 ...
 */
public class AcceptFormats extends AcceptFormatsType 
implements java.io.Serializable
{
    ...
    public AcceptFormats() 
     {
        super();
    } //-- nl.b3p.xml.ows.v100.AcceptFormats()
    ...
    public static nl.b3p.xml.ows.v100.AcceptFormatsType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.AcceptFormatsType) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.AcceptFormats.class, reader);
