...
public class ContactType implements java.io.Serializable {
     ...
     * may be contacted. 
     */
    private nl.b3p.xml.ows.v100.Phone _phone;

    /**
     * Physical and email address at which the organization or
     * individual may be contacted. 
     */
    private nl.b3p.xml.ows.v100.Address _address;
     ...
     * not be used. 
     */
    private nl.b3p.xml.ows.v100.OnlineResource _onlineResource;
    ...
    public ContactType() 
     {
        super();
    } //-- nl.b3p.xml.ows.v100.ContactType()
     ...
     */
    public nl.b3p.xml.ows.v100.Address getAddress()
    {
        return this._address;
    } //-- nl.b3p.xml.ows.v100.Address getAddress() 
     ...
     */
    public nl.b3p.xml.ows.v100.OnlineResource getOnlineResource()
    {
        return this._onlineResource;
    } //-- nl.b3p.xml.ows.v100.OnlineResource getOnlineResource() 
     ...
     */
    public nl.b3p.xml.ows.v100.Phone getPhone()
    {
        return this._phone;
    } //-- nl.b3p.xml.ows.v100.Phone getPhone() 
     ...
     */
    public void setAddress(nl.b3p.xml.ows.v100.Address address)
    {
        this._address = address;
    } //-- void setAddress(nl.b3p.xml.ows.v100.Address) 
     ...
     */
    public void setOnlineResource(nl.b3p.xml.ows.v100.OnlineResource onlineResource)
    {
        this._onlineResource = onlineResource;
    } //-- void setOnlineResource(nl.b3p.xml.ows.v100.OnlineResource) 
     ...
     */
    public void setPhone(nl.b3p.xml.ows.v100.Phone phone)
    {
        this._phone = phone;
    } //-- void setPhone(nl.b3p.xml.ows.v100.Phone) 
     ...
     * @return ContactType
     */
    public static nl.b3p.xml.ows.v100.ContactType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.ContactType) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.ContactType.class, reader);
    } //-- nl.b3p.xml.ows.v100.ContactType unmarshal(java.io.Reader) 
