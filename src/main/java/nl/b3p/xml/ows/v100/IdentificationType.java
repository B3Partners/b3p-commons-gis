 ...
 */
public class IdentificationType extends nl.b3p.xml.ows.v100.DescriptionType 
implements java.io.Serializable
{
     ...
     */
    private nl.b3p.xml.ows.v100.Identifier _identifier;
    ...
    } //-- nl.b3p.xml.ows.v100.IdentificationType()
     ...
     * @param vBoundingBox
     */
    public void addBoundingBox(nl.b3p.xml.ows.v100.BoundingBox vBoundingBox)
        throws java.lang.IndexOutOfBoundsException
    {
        _boundingBoxList.add(vBoundingBox);
    } //-- void addBoundingBox(nl.b3p.xml.ows.v100.BoundingBox) 
     ...
     * @param vBoundingBox
     */
    public void addBoundingBox(int index, nl.b3p.xml.ows.v100.BoundingBox vBoundingBox)
        throws java.lang.IndexOutOfBoundsException
    {
        _boundingBoxList.add(index, vBoundingBox);
    } //-- void addBoundingBox(int, nl.b3p.xml.ows.v100.BoundingBox) 
     ...
     * @return BoundingBox
     */
    public nl.b3p.xml.ows.v100.BoundingBox getBoundingBox(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        ...
        return (nl.b3p.xml.ows.v100.BoundingBox) _boundingBoxList.get(index);
    } //-- nl.b3p.xml.ows.v100.BoundingBox getBoundingBox(int) 
     ...
     * @return BoundingBox
     */
    public nl.b3p.xml.ows.v100.BoundingBox[] getBoundingBox()
    {
        int size = _boundingBoxList.size();
        nl.b3p.xml.ows.v100.BoundingBox[] mArray = new nl.b3p.xml.ows.v100.BoundingBox[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (nl.b3p.xml.ows.v100.BoundingBox) _boundingBoxList.get(index);
        }
        return mArray;
    } //-- nl.b3p.xml.ows.v100.BoundingBox[] getBoundingBox() 
     ...
     */
    public nl.b3p.xml.ows.v100.Identifier getIdentifier()
    {
        return this._identifier;
    } //-- nl.b3p.xml.ows.v100.Identifier getIdentifier() 
     ...
     * @return boolean
     */
    public boolean removeBoundingBox(nl.b3p.xml.ows.v100.BoundingBox vBoundingBox)
    {
        boolean removed = _boundingBoxList.remove(vBoundingBox);
        return removed;
    } //-- boolean removeBoundingBox(nl.b3p.xml.ows.v100.BoundingBox) 
     ...
     * @param vBoundingBox
     */
    public void setBoundingBox(int index, nl.b3p.xml.ows.v100.BoundingBox vBoundingBox)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index >= _boundingBoxList.size())) {
    ...
    } //-- void setBoundingBox(int, nl.b3p.xml.ows.v100.BoundingBox) 
     ...
     */
    public void setBoundingBox(nl.b3p.xml.ows.v100.BoundingBox[] boundingBoxArray)
    {
        //-- copy array
        _boundingBoxList.clear();
    ...
    } //-- void setBoundingBox(nl.b3p.xml.ows.v100.BoundingBox) 
     ...
     */
    public void setIdentifier(nl.b3p.xml.ows.v100.Identifier identifier)
    {
        this._identifier = identifier;
    } //-- void setIdentifier(nl.b3p.xml.ows.v100.Identifier) 
     ...
     */
    public static nl.b3p.xml.ows.v100.DescriptionType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.DescriptionType) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.IdentificationType.class, reader);
    } //-- nl.b3p.xml.ows.v100.DescriptionType unmarshal(java.io.Reader) 
