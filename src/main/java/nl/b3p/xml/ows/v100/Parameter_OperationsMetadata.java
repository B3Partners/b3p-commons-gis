...
implements java.io.Serializable
{
    ...
    public Parameter_OperationsMetadata() 
     {
        super();
    } //-- nl.b3p.xml.ows.v100.Parameter_OperationsMetadata()
    ...
    public static nl.b3p.xml.ows.v100.DomainType unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (nl.b3p.xml.ows.v100.DomainType) Unmarshaller.unmarshal(nl.b3p.xml.ows.v100.Parameter_OperationsMetadata.class, reader);
