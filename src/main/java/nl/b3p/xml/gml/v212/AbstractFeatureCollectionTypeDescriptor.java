 ...
 */
public class AbstractFeatureCollectionTypeDescriptor extends nl.b3p.xml.gml.v212.AbstractFeatureCollectionBaseTypeDescriptor {
    ...
    public AbstractFeatureCollectionTypeDescriptor() 
     {
        super();
        setExtendsWithoutFlatten(new nl.b3p.xml.gml.v212.AbstractFeatureCollectionBaseTypeDescriptor());
    ...
    } //-- nl.b3p.xml.gml.v212.AbstractFeatureCollectionTypeDescriptor()
    ...
    {
        return nl.b3p.xml.gml.v212.AbstractFeatureCollectionType.class;
