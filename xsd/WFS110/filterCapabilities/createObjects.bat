...
@echo OGC
"%JDK_DIR%\bin\java" -cp %CP% org.exolab.castor.builder.SourceGenerator -i ../v110/filterCapabilities.xsd  -types j2 -package nl.b3p.xml.ogc.v110.capabilities -binding-file binding.xml
@pause